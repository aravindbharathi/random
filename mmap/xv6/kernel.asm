...
8010005a:	e8 01 45 00 00       	call   80104560 <initlock>
  bcache.head.next = &bcache.head;
...
801000e8:	e8 f3 45 00 00       	call   801046e0 <acquire>
...
801001c2:	e8 39 43 00 00       	call   80104500 <holdingsleep>
...
80100203:	e8 f8 42 00 00       	call   80104500 <holdingsleep>
...
80100213:	e8 a8 42 00 00       	call   801044c0 <releasesleep>

  acquire(&bcache.lock);
80100218:	c7 04 24 c0 b5 10 80 	movl   $0x8010b5c0,(%esp)
8010021f:	e8 bc 44 00 00       	call   801046e0 <acquire>
  b->refcnt--;
...
801002b1:	e8 2a 44 00 00       	call   801046e0 <acquire>
...
80100365:	e8 36 44 00 00       	call   801047a0 <release>
  ilock(ip);
8010036a:	58                   	pop    %eax
...
801003dc:	e8 9f 41 00 00       	call   80104580 <getcallerpcs>
  for(i=0; i<10; i++)
...
8010065f:	e8 7c 40 00 00       	call   801046e0 <acquire>
  for(i = 0; i < n; i++)
...
80100697:	e8 04 41 00 00       	call   801047a0 <release>
  ilock(ip);
8010069c:	58                   	pop    %eax
...
801007bd:	e8 1e 3f 00 00       	call   801046e0 <acquire>
...
80100828:	e8 73 3f 00 00       	call   801047a0 <release>
...
80100877:	e8 64 3e 00 00       	call   801046e0 <acquire>
  while((c = getc()) >= 0){
...
801009cf:	e8 cc 3d 00 00       	call   801047a0 <release>
  if(doprocdump) {
...
80100a44:	e8 17 3b 00 00       	call   80104560 <initlock>
...
80100ca3:	e8 48 3d 00 00       	call   801049f0 <strlen>
...
80100cb6:	e8 35 3d 00 00       	call   801049f0 <strlen>
...
80100d71:	e8 3a 3c 00 00       	call   801049b0 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100df4:	e8 67 37 00 00       	call   80104560 <initlock>
}
...
80100e15:	e8 c6 38 00 00       	call   801046e0 <acquire>
...
80100e41:	e8 5a 39 00 00       	call   801047a0 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100e5a:	e8 41 39 00 00       	call   801047a0 <release>
}
...
80100e83:	e8 58 38 00 00       	call   801046e0 <acquire>
  if(f->ref < 1)
...
80100ea0:	e8 fb 38 00 00       	call   801047a0 <release>
  return f;
}
...
80100ed5:	e8 06 38 00 00       	call   801046e0 <acquire>
  if(f->ref < 1)
...
80100f0d:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100f10:	e8 8b 38 00 00       	call   801047a0 <release>
...
80100f3d:	5d                   	pop    %ebp
    release(&ftable.lock);
80100f3e:	e9 5d 38 00 00       	jmp    801047a0 <release>
...
80101315:	e8 d6 34 00 00       	call   801047f0 <memset>
  log_write(bp);
...
8010135a:	e8 81 33 00 00       	call   801046e0 <acquire>
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
...
801013c7:	e8 d4 33 00 00       	call   801047a0 <release>
...
801013f2:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
801013f5:	e8 a6 33 00 00       	call   801047a0 <release>
      return ip;
...
80101525:	e8 66 33 00 00       	call   80104890 <memmove>
  brelse(bp);
...
8010155a:	e8 01 30 00 00       	call   80104560 <initlock>
  for(i = 0; i < NINODE; i++) {
...
80101577:	e8 a4 2e 00 00       	call   80104420 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
8010165e:	e8 8d 31 00 00       	call   801047f0 <memset>
      dip->type = type;
...
80101705:	e8 86 31 00 00       	call   80104890 <memmove>
  log_write(bp);
...
80101743:	e8 98 2f 00 00       	call   801046e0 <acquire>
  ip->ref++;
80101748:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
8010174c:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101753:	e8 48 30 00 00       	call   801047a0 <release>
}
...
80101786:	e8 d5 2c 00 00       	call   80104460 <acquiresleep>
  if(ip->valid == 0){
...
801017f8:	e8 93 30 00 00       	call   80104890 <memmove>
    brelse(bp);
...
80101857:	e8 a4 2c 00 00       	call   80104500 <holdingsleep>
...
80101872:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
80101873:	e9 48 2c 00 00       	jmp    801044c0 <releasesleep>
    panic("iunlock");
...
801018a4:	e8 b7 2b 00 00       	call   80104460 <acquiresleep>
...
801018be:	e8 fd 2b 00 00       	call   801044c0 <releasesleep>
  acquire(&icache.lock);
801018c3:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
801018ca:	e8 11 2e 00 00       	call   801046e0 <acquire>
  ip->ref--;
...
801018e3:	5d                   	pop    %ebp
  release(&icache.lock);
801018e4:	e9 b7 2e 00 00       	jmp    801047a0 <release>
801018e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    acquire(&icache.lock);
801018f0:	83 ec 0c             	sub    $0xc,%esp
801018f3:	68 e0 09 11 80       	push   $0x801109e0
801018f8:	e8 e3 2d 00 00       	call   801046e0 <acquire>
    int r = ip->ref;
801018fd:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101900:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101907:	e8 94 2e 00 00       	call   801047a0 <release>
    if(r == 1){
...
80101b07:	e8 84 2d 00 00       	call   80104890 <memmove>
    brelse(bp);
...
80101c03:	e8 88 2c 00 00       	call   80104890 <memmove>
    log_write(bp);
...
80101ca2:	e8 59 2c 00 00       	call   80104900 <strncmp>
}
80101ca7:	c9                   	leave  
80101ca8:	c3                   	ret    
...
80101d05:	e8 f6 2b 00 00       	call   80104900 <strncmp>
      continue;
...
80101d9c:	e8 3f 29 00 00       	call   801046e0 <acquire>
  ip->ref++;
80101da1:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101da5:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101dac:	e8 ef 29 00 00       	call   801047a0 <release>
...
80101e17:	e8 74 2a 00 00       	call   80104890 <memmove>
...
80101ea3:	e8 e8 29 00 00       	call   80104890 <memmove>
    name[len] = 0;
...
80101fd5:	e8 76 29 00 00       	call   80104950 <strncpy>
...
80102164:	e8 f7 23 00 00       	call   80104560 <initlock>
...
801021f2:	e8 e9 24 00 00       	call   801046e0 <acquire>
...
8010226b:	e8 30 25 00 00       	call   801047a0 <release>
...
80102292:	e8 69 22 00 00       	call   80104500 <holdingsleep>
...
801022cc:	e8 0f 24 00 00       	call   801046e0 <acquire>
...
80102335:	c9                   	leave  
  release(&idelock);
80102336:	e9 65 24 00 00       	jmp    801047a0 <release>
...
801024a6:	e8 45 23 00 00       	call   801047f0 <memset>
...
801024e0:	e8 fb 21 00 00       	call   801046e0 <acquire>
...
801024fa:	c9                   	leave  
    release(&kmem.lock);
801024fb:	e9 a0 22 00 00       	jmp    801047a0 <release>
    panic("kfree");
...
80102579:	e8 e2 1f 00 00       	call   80104560 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
80102663:	e8 78 20 00 00       	call   801046e0 <acquire>
  r = kmem.freelist;
...
80102691:	e8 0a 21 00 00       	call   801047a0 <release>
  return (char*)r;
...
80102abf:	e8 7c 1d 00 00       	call   80104840 <memcmp>
...
80102bf4:	e8 97 1c 00 00       	call   80104890 <memmove>
...
80102ca8:	e8 b3 18 00 00       	call   80104560 <initlock>
  readsb(dev, &sb);
80102cad:	58                   	pop    %eax
...
80102d3f:	e8 9c 19 00 00       	call   801046e0 <acquire>
...
80102d94:	e8 07 1a 00 00       	call   801047a0 <release>
      break;
    }
  }
}
...
80102db2:	e8 29 19 00 00       	call   801046e0 <acquire>
  log.outstanding -= 1;
...
80102df0:	e8 ab 19 00 00       	call   801047a0 <release>
}
...
80102e0a:	e8 d1 18 00 00       	call   801046e0 <acquire>
    wakeup(&log);
...
80102e2c:	e8 6f 19 00 00       	call   801047a0 <release>
...
80102e84:	e8 07 1a 00 00       	call   80104890 <memmove>
...
80102ee4:	e8 b7 18 00 00       	call   801047a0 <release>
...
80102f52:	e8 89 17 00 00       	call   801046e0 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102f94:	c9                   	leave  
  release(&log.lock);
80102f95:	e9 06 18 00 00       	jmp    801047a0 <release>
...
80103002:	e8 79 2b 00 00       	call   80105b80 <idtinit>
...
8010308d:	e8 1e 08 00 00       	call   801038b0 <pinit>
  tvinit();        // trap vectors
80103092:	e8 69 2a 00 00       	call   80105b00 <tvinit>
  binit();         // buffer cache
...
801030b8:	e8 d3 17 00 00       	call   80104890 <memmove>
...
801031a4:	e8 97 16 00 00       	call   80104840 <memcmp>
...
80103260:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
80103263:	e8 d8 15 00 00       	call   80104840 <memcmp>
...
8010346d:	e8 ee 10 00 00       	call   80104560 <initlock>
  (*f0)->type = FD_PIPE;
...
80103513:	e8 c8 11 00 00       	call   801046e0 <acquire>
  if(writable){
...
80103557:	5d                   	pop    %ebp
    release(&p->lock);
80103558:	e9 43 12 00 00       	jmp    801047a0 <release>
...
80103584:	e8 17 12 00 00       	call   801047a0 <release>
    kfree((char*)p);
...
801035b1:	e8 2a 11 00 00       	call   801046e0 <acquire>
  for(i = 0; i < n; i++){
...
8010363c:	e8 5f 11 00 00       	call   801047a0 <release>
        return -1;
...
80103692:	e8 09 11 00 00       	call   801047a0 <release>
  return n;
...
801036ba:	e8 21 10 00 00       	call   801046e0 <acquire>
...
8010375e:	e8 3d 10 00 00       	call   801047a0 <release>
  return i;
...
80103779:	e8 22 10 00 00       	call   801047a0 <release>
      return -1;
...
801037a1:	e8 3a 0f 00 00       	call   801046e0 <acquire>
...
801037dc:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
801037e2:	e8 b9 0f 00 00       	call   801047a0 <release>
...
80103804:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103807:	c7 40 14 ee 5a 10 80 	movl   $0x80105aee,0x14(%eax)
  p->context = (struct context*)sp;
...
80103816:	e8 d5 0f 00 00       	call   801047f0 <memset>
...
8010383a:	e8 61 0f 00 00       	call   801047a0 <release>
}
...
8010386f:	e8 2c 0f 00 00       	call   801047a0 <release>
...
801038c4:	e8 97 0c 00 00       	call   80104560 <initlock>
}
...
8010392d:	68 6c 7a 10 80       	push   $0x80107a6c
...
80103968:	83 ec 04             	sub    $0x4,%esp
  pushcli();
8010396b:	e8 70 0c 00 00       	call   801045e0 <pushcli>
  c = mycpu();
80103970:	e8 5b ff ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103975:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010397b:	e8 b0 0c 00 00       	call   80104630 <popcli>
}
...
801039da:	e8 11 0e 00 00       	call   801047f0 <memset>
...
80103a39:	e8 72 0f 00 00       	call   801049b0 <safestrcpy>
  p->cwd = namei("/");
...
80103a99:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103a9c:	e8 3f 0b 00 00       	call   801045e0 <pushcli>
  c = mycpu();
80103aa1:	e8 2a fe ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103aa6:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103aac:	e8 7f 0b 00 00       	call   80104630 <popcli>
  sz = curproc->sz;
...
80103b1a:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b1d:	e8 be 0a 00 00       	call   801045e0 <pushcli>
  c = mycpu();
80103b22:	e8 a9 fd ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103b27:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b2d:	e8 fe 0a 00 00       	call   80104630 <popcli>
  if((np = allocproc()) == 0){
...
80103c66:	e8 75 0a 00 00       	call   801046e0 <acquire>
...
80103c8b:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103c92:	e8 7c 0d 00 00       	call   80104a13 <swtch>
      switchkvm();
...
80103cbc:	e8 df 0a 00 00       	call   801047a0 <release>
    sti();
...
80103d37:	e8 d7 0c 00 00       	call   80104a13 <swtch>
  mycpu()->intena = intena;
...
80103d9a:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103d9d:	e8 3e 08 00 00       	call   801045e0 <pushcli>
  c = mycpu();
80103da2:	e8 29 fb ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103da7:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103dad:	e8 7e 08 00 00       	call   80104630 <popcli>
  if(curproc == initproc)
...
80103e0a:	e8 d1 08 00 00       	call   801046e0 <acquire>
...
80103ee0:	e8 fb 07 00 00       	call   801046e0 <acquire>
  pushcli();
80103ee5:	e8 f6 06 00 00       	call   801045e0 <pushcli>
  c = mycpu();
80103eea:	e8 e1 f9 ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103eef:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ef5:	e8 36 07 00 00       	call   80104630 <popcli>
...
80103f0d:	e8 8e 08 00 00       	call   801047a0 <release>
}
...
80103f30:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103f33:	e8 a8 06 00 00       	call   801045e0 <pushcli>
  c = mycpu();
80103f38:	e8 93 f9 ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103f3d:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f43:	e8 e8 06 00 00       	call   80104630 <popcli>
  if(p == 0)
...
80103f64:	e8 77 07 00 00       	call   801046e0 <acquire>
    release(lk);
80103f69:	89 34 24             	mov    %esi,(%esp)
80103f6c:	e8 2f 08 00 00       	call   801047a0 <release>
  p->chan = chan;
...
80103f8e:	e8 0d 08 00 00       	call   801047a0 <release>
    acquire(lk);
...
80103f9f:	5d                   	pop    %ebp
    acquire(lk);
80103fa0:	e9 3b 07 00 00       	jmp    801046e0 <acquire>
...
801040a6:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
801040ad:	e8 ee 06 00 00       	call   801047a0 <release>
        return pid;
...
801040cb:	e8 d0 06 00 00       	call   801047a0 <release>
      return -1;
...
801040f3:	e8 e8 05 00 00       	call   801046e0 <acquire>
...
80104138:	c9                   	leave  
  release(&ptable.lock);
80104139:	e9 62 06 00 00       	jmp    801047a0 <release>
...
80104153:	e8 88 05 00 00       	call   801046e0 <acquire>
...
80104193:	e8 08 06 00 00       	call   801047a0 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
801041b0:	e8 eb 05 00 00       	call   801047a0 <release>
}
...
801041f3:	68 57 7e 10 80       	push   $0x80107e57
...
80104220:	8b 14 85 94 7a 10 80 	mov    -0x7fef856c(,%eax,4),%edx
      state = "???";
...
8010425d:	e8 1e 03 00 00       	call   80104580 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
// For processes that run in user mode
// PA1
int getNumProc()
{
...
801042bf:	75 ef                	jne    801042b0 <getNumProc+0x10>
  }
  return N;
}
...
801042d7:	56                   	push   %esi
  popcli();
801042d8:	be 0a 00 00 00       	mov    $0xa,%esi
{
801042dd:	53                   	push   %ebx
  pushcli();
801042de:	e8 fd 02 00 00       	call   801045e0 <pushcli>
  c = mycpu();
801042e3:	e8 e8 f5 ff ff       	call   801038d0 <mycpu>
  p = c->proc;
801042e8:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801042ee:	e8 3d 03 00 00       	call   80104630 <popcli>
  struct proc *curproc = myproc();
  struct proc *pproc;
  int i;
  for(i=0; i<10 && curproc->pid>=1; i++)
801042f3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801042f7:	90                   	nop
801042f8:	8b 43 10             	mov    0x10(%ebx),%eax
801042fb:	85 c0                	test   %eax,%eax
801042fd:	7e 19                	jle    80104318 <showAncestry+0x48>
  {
    cprintf("PID = %d\n", curproc->pid);
801042ff:	83 ec 08             	sub    $0x8,%esp
80104302:	50                   	push   %eax
80104303:	68 38 7a 10 80       	push   $0x80107a38
80104308:	e8 a3 c3 ff ff       	call   801006b0 <cprintf>
    pproc = curproc->parent;
8010430d:	8b 5b 14             	mov    0x14(%ebx),%ebx
  for(i=0; i<10 && curproc->pid>=1; i++)
80104310:	83 c4 10             	add    $0x10,%esp
80104313:	83 ee 01             	sub    $0x1,%esi
80104316:	75 e0                	jne    801042f8 <showAncestry+0x28>
    curproc = pproc;
  }
}
...
80104328:	83 ec 04             	sub    $0x4,%esp
  pushcli();
8010432b:	e8 b0 02 00 00       	call   801045e0 <pushcli>
  c = mycpu();
80104330:	e8 9b f5 ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80104335:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010433b:	e8 f0 02 00 00       	call   80104630 <popcli>
  int num_vp = 0;
  struct proc *p = myproc();

  if(p->sz % PGSIZE == 0)
80104340:	8b 0b                	mov    (%ebx),%ecx
    num_vp = p->sz / PGSIZE;
80104342:	89 ca                	mov    %ecx,%edx
80104344:	c1 ea 0c             	shr    $0xc,%edx
80104347:	81 e1 ff 0f 00 00    	and    $0xfff,%ecx
8010434d:	8d 42 01             	lea    0x1(%edx),%eax
80104350:	0f 44 c2             	cmove  %edx,%eax
  else
    num_vp = p->sz / PGSIZE + 1;
...
8010436a:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
8010436d:	e8 6e 02 00 00       	call   801045e0 <pushcli>
  c = mycpu();
80104372:	e8 59 f5 ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80104377:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010437d:	e8 ae 02 00 00       	call   80104630 <popcli>
  int num_pp = 0;
  char *addr = 0;
  uint i = 0;
  struct proc *p = myproc();
  ...
  pde_t* pgdir = p->pgdir;
80104382:	8b 73 04             	mov    0x4(%ebx),%esi
  pte_t* pte;
  uint sz = p->sz;
80104385:	8b 1b                	mov    (%ebx),%ebx

  for (i = 0; i < sz; i+=PGSIZE)
80104387:	85 db                	test   %ebx,%ebx
80104389:	74 4d                	je     801043d8 <numpp+0x78>
8010438b:	31 c0                	xor    %eax,%eax
  int num_pp = 0;
8010438d:	31 c9                	xor    %ecx,%ecx
8010438f:	90                   	nop
  pde = &pgdir[PDX(va)];
80104390:	89 c2                	mov    %eax,%edx
80104392:	c1 ea 16             	shr    $0x16,%edx
  if(*pde & PTE_P){
80104395:	8b 14 96             	mov    (%esi,%edx,4),%edx
80104398:	f6 c2 01             	test   $0x1,%dl
8010439b:	74 21                	je     801043be <numpp+0x5e>
  if (*&pgtab[PTX(va)] & PTE_P)
8010439d:	89 c7                	mov    %eax,%edi
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
8010439f:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
  if (*&pgtab[PTX(va)] & PTE_P)
801043a5:	c1 ef 0c             	shr    $0xc,%edi
801043a8:	81 e7 ff 03 00 00    	and    $0x3ff,%edi
801043ae:	8b 94 ba 00 00 00 80 	mov    -0x80000000(%edx,%edi,4),%edx
801043b5:	83 e2 01             	and    $0x1,%edx
    if((pte = walkpgdir(pgdir, addr+i, 0)) != 0)
      num_pp++;
801043b8:	83 fa 01             	cmp    $0x1,%edx
801043bb:	83 d9 ff             	sbb    $0xffffffff,%ecx
  for (i = 0; i < sz; i+=PGSIZE)
801043be:	05 00 10 00 00       	add    $0x1000,%eax
801043c3:	39 c3                	cmp    %eax,%ebx
801043c5:	77 c9                	ja     80104390 <numpp+0x30>

  return num_pp;
}
801043c7:	83 c4 0c             	add    $0xc,%esp
801043ca:	89 c8                	mov    %ecx,%eax
801043cc:	5b                   	pop    %ebx
801043cd:	5e                   	pop    %esi
801043ce:	5f                   	pop    %edi
801043cf:	5d                   	pop    %ebp
...
801043d8:	83 c4 0c             	add    $0xc,%esp
  int num_pp = 0;
801043db:	31 c9                	xor    %ecx,%ecx
}
801043dd:	5b                   	pop    %ebx
801043de:	89 c8                	mov    %ecx,%eax
801043e0:	5e                   	pop    %esi
801043e1:	5f                   	pop    %edi
801043e2:	5d                   	pop    %ebp
801043e3:	c3                   	ret    
...
801043f8:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801043fb:	e8 e0 01 00 00       	call   801045e0 <pushcli>
  c = mycpu();
80104400:	e8 cb f4 ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80104405:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010440b:	e8 20 02 00 00       	call   80104630 <popcli>
  struct proc *p = myproc();
  int addr = p->sz;
  p->sz += size;
...
80104413:	8b 03                	mov    (%ebx),%eax
  p->sz += size;
80104415:	01 c2                	add    %eax,%edx
80104417:	89 13                	mov    %edx,(%ebx)
  return addr;
80104419:	83 c4 04             	add    $0x4,%esp
8010441c:	5b                   	pop    %ebx
8010441d:	5d                   	pop    %ebp
8010441e:	c3                   	ret    
8010441f:	90                   	nop
...
8010442e:	68 ac 7a 10 80       	push   $0x80107aac
80104433:	8d 43 04             	lea    0x4(%ebx),%eax
80104436:	50                   	push   %eax
80104437:	e8 24 01 00 00       	call   80104560 <initlock>
  lk->name = name;
8010443c:	8b 45 0c             	mov    0xc(%ebp),%eax
  lk->locked = 0;
...
80104445:	83 c4 10             	add    $0x10,%esp
  lk->pid = 0;
80104448:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
  lk->name = name;
8010444f:	89 43 38             	mov    %eax,0x38(%ebx)
}
...
80104473:	e8 68 02 00 00       	call   801046e0 <acquire>
  while (lk->locked) {
80104478:	8b 13                	mov    (%ebx),%edx
8010447a:	83 c4 10             	add    $0x10,%esp
8010447d:	85 d2                	test   %edx,%edx
8010447f:	74 1a                	je     8010449b <acquiresleep+0x3b>
80104481:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    sleep(lk, &lk->lk);
80104488:	83 ec 08             	sub    $0x8,%esp
8010448b:	56                   	push   %esi
8010448c:	53                   	push   %ebx
8010448d:	e8 8e fa ff ff       	call   80103f20 <sleep>
  while (lk->locked) {
80104492:	8b 03                	mov    (%ebx),%eax
80104494:	83 c4 10             	add    $0x10,%esp
80104497:	85 c0                	test   %eax,%eax
80104499:	75 ed                	jne    80104488 <acquiresleep+0x28>
  }
  lk->locked = 1;
8010449b:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
801044a1:	e8 ba f4 ff ff       	call   80103960 <myproc>
801044a6:	8b 40 10             	mov    0x10(%eax),%eax
801044a9:	89 43 3c             	mov    %eax,0x3c(%ebx)
  release(&lk->lk);
801044ac:	89 75 08             	mov    %esi,0x8(%ebp)
}
...
801044b4:	5d                   	pop    %ebp
  release(&lk->lk);
801044b5:	e9 e6 02 00 00       	jmp    801047a0 <release>
...
801044d3:	e8 08 02 00 00       	call   801046e0 <acquire>
  lk->locked = 0;
801044d8:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  lk->pid = 0;
801044de:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
  wakeup(lk);
801044e5:	89 1c 24             	mov    %ebx,(%esp)
801044e8:	e8 f3 fb ff ff       	call   801040e0 <wakeup>
  release(&lk->lk);
801044ed:	89 75 08             	mov    %esi,0x8(%ebp)
...
801044f8:	5d                   	pop    %ebp
  release(&lk->lk);
801044f9:	e9 a2 02 00 00       	jmp    801047a0 <release>
...
80104508:	31 ff                	xor    %edi,%edi
8010450a:	56                   	push   %esi
8010450b:	53                   	push   %ebx
8010450c:	83 ec 18             	sub    $0x18,%esp
8010450f:	8b 5d 08             	mov    0x8(%ebp),%ebx
  int r;
  
  acquire(&lk->lk);
80104512:	8d 73 04             	lea    0x4(%ebx),%esi
80104515:	56                   	push   %esi
80104516:	e8 c5 01 00 00       	call   801046e0 <acquire>
  r = lk->locked && (lk->pid == myproc()->pid);
8010451b:	8b 03                	mov    (%ebx),%eax
8010451d:	83 c4 10             	add    $0x10,%esp
80104520:	85 c0                	test   %eax,%eax
80104522:	75 1c                	jne    80104540 <holdingsleep+0x40>
  release(&lk->lk);
80104524:	83 ec 0c             	sub    $0xc,%esp
80104527:	56                   	push   %esi
80104528:	e8 73 02 00 00       	call   801047a0 <release>
  return r;
}
8010452d:	8d 65 f4             	lea    -0xc(%ebp),%esp
80104530:	89 f8                	mov    %edi,%eax
80104532:	5b                   	pop    %ebx
80104533:	5e                   	pop    %esi
80104534:	5f                   	pop    %edi
80104535:	5d                   	pop    %ebp
...
80104543:	e8 18 f4 ff ff       	call   80103960 <myproc>
80104548:	39 58 10             	cmp    %ebx,0x10(%eax)
8010454b:	0f 94 c0             	sete   %al
8010454e:	0f b6 c0             	movzbl %al,%eax
80104551:	89 c7                	mov    %eax,%edi
80104553:	eb cf                	jmp    80104524 <holdingsleep+0x24>
80104555:	66 90                	xchg   %ax,%ax
80104557:	66 90                	xchg   %ax,%ax
80104559:	66 90                	xchg   %ax,%ax
8010455b:	66 90                	xchg   %ax,%ax
...
80104567:	8b 45 08             	mov    0x8(%ebp),%eax
  lk->name = name;
8010456a:	8b 55 0c             	mov    0xc(%ebp),%edx
  lk->locked = 0;
8010456d:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->name = name;
80104573:	89 50 04             	mov    %edx,0x4(%eax)
  lk->cpu = 0;
80104576:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
8010457d:	5d                   	pop    %ebp
8010457e:	c3                   	ret    
8010457f:	90                   	nop
...
{
8010458d:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  ebp = (uint*)v - 2;
80104590:	83 e8 08             	sub    $0x8,%eax
  for(i = 0; i < 10; i++){
80104593:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104597:	90                   	nop
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80104598:	8d 98 00 00 00 80    	lea    -0x80000000(%eax),%ebx
8010459e:	81 fb fe ff ff 7f    	cmp    $0x7ffffffe,%ebx
801045a4:	77 1a                	ja     801045c0 <getcallerpcs+0x40>
      break;
    pcs[i] = ebp[1];     // saved %eip
801045a6:	8b 58 04             	mov    0x4(%eax),%ebx
801045a9:	89 1c 91             	mov    %ebx,(%ecx,%edx,4)
  for(i = 0; i < 10; i++){
801045ac:	83 c2 01             	add    $0x1,%edx
    ebp = (uint*)ebp[0]; // saved %ebp
801045af:	8b 00                	mov    (%eax),%eax
  for(i = 0; i < 10; i++){
801045b1:	83 fa 0a             	cmp    $0xa,%edx
801045b4:	75 e2                	jne    80104598 <getcallerpcs+0x18>
  }
  for(; i < 10; i++)
    pcs[i] = 0;
}
...
801045b9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  for(; i < 10; i++)
801045c0:	8d 04 91             	lea    (%ecx,%edx,4),%eax
801045c3:	8d 51 28             	lea    0x28(%ecx),%edx
...
801045db:	75 f3                	jne    801045d0 <getcallerpcs+0x50>
}
801045dd:	5b                   	pop    %ebx
801045de:	5d                   	pop    %ebp
801045df:	c3                   	ret    
...
801045ed:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
801045ee:	e8 dd f2 ff ff       	call   801038d0 <mycpu>
801045f3:	8b 80 a4 00 00 00    	mov    0xa4(%eax),%eax
801045f9:	85 c0                	test   %eax,%eax
801045fb:	74 13                	je     80104610 <pushcli+0x30>
    mycpu()->intena = eflags & FL_IF;
  mycpu()->ncli += 1;
801045fd:	e8 ce f2 ff ff       	call   801038d0 <mycpu>
80104602:	83 80 a4 00 00 00 01 	addl   $0x1,0xa4(%eax)
}
...
8010460f:	90                   	nop
    mycpu()->intena = eflags & FL_IF;
80104610:	e8 bb f2 ff ff       	call   801038d0 <mycpu>
80104615:	81 e3 00 02 00 00    	and    $0x200,%ebx
8010461b:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
80104621:	eb da                	jmp    801045fd <pushcli+0x1d>
...
8010463b:	58                   	pop    %eax
  if(readeflags()&FL_IF)
8010463c:	f6 c4 02             	test   $0x2,%ah
8010463f:	75 31                	jne    80104672 <popcli+0x42>
    panic("popcli - interruptible");
  if(--mycpu()->ncli < 0)
80104641:	e8 8a f2 ff ff       	call   801038d0 <mycpu>
80104646:	83 a8 a4 00 00 00 01 	subl   $0x1,0xa4(%eax)
8010464d:	78 30                	js     8010467f <popcli+0x4f>
    panic("popcli");
  if(mycpu()->ncli == 0 && mycpu()->intena)
8010464f:	e8 7c f2 ff ff       	call   801038d0 <mycpu>
80104654:	8b 90 a4 00 00 00    	mov    0xa4(%eax),%edx
8010465a:	85 d2                	test   %edx,%edx
8010465c:	74 02                	je     80104660 <popcli+0x30>
    sti();
}
8010465e:	c9                   	leave  
8010465f:	c3                   	ret    
...
8010466d:	74 ef                	je     8010465e <popcli+0x2e>
  asm volatile("sti");
8010466f:	fb                   	sti    
}
80104670:	c9                   	leave  
...
80104675:	68 b7 7a 10 80       	push   $0x80107ab7
8010467a:	e8 11 bd ff ff       	call   80100390 <panic>
    panic("popcli");
8010467f:	83 ec 0c             	sub    $0xc,%esp
80104682:	68 ce 7a 10 80       	push   $0x80107ace
...
8010469c:	31 db                	xor    %ebx,%ebx
  pushcli();
8010469e:	e8 3d ff ff ff       	call   801045e0 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
801046a3:	8b 06                	mov    (%esi),%eax
801046a5:	85 c0                	test   %eax,%eax
801046a7:	75 0f                	jne    801046b8 <holding+0x28>
  popcli();
801046a9:	e8 82 ff ff ff       	call   80104630 <popcli>
}
...
801046b4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  r = lock->locked && lock->cpu == mycpu();
801046b8:	8b 5e 08             	mov    0x8(%esi),%ebx
801046bb:	e8 10 f2 ff ff       	call   801038d0 <mycpu>
801046c0:	39 c3                	cmp    %eax,%ebx
801046c2:	0f 94 c3             	sete   %bl
  popcli();
801046c5:	e8 66 ff ff ff       	call   80104630 <popcli>
  r = lock->locked && lock->cpu == mycpu();
801046ca:	0f b6 db             	movzbl %bl,%ebx
}
...
801046e9:	e8 f2 fe ff ff       	call   801045e0 <pushcli>
  if(holding(lk))
801046ee:	8b 5d 08             	mov    0x8(%ebp),%ebx
801046f1:	83 ec 0c             	sub    $0xc,%esp
801046f4:	53                   	push   %ebx
801046f5:	e8 96 ff ff ff       	call   80104690 <holding>
801046fa:	83 c4 10             	add    $0x10,%esp
801046fd:	85 c0                	test   %eax,%eax
801046ff:	0f 85 7f 00 00 00    	jne    80104784 <acquire+0xa4>
80104705:	89 c6                	mov    %eax,%esi
  asm volatile("lock; xchgl %0, %1" :
80104707:	ba 01 00 00 00       	mov    $0x1,%edx
8010470c:	eb 05                	jmp    80104713 <acquire+0x33>
...
80104724:	e8 a7 f1 ff ff       	call   801038d0 <mycpu>
80104729:	89 43 08             	mov    %eax,0x8(%ebx)
  ebp = (uint*)v - 2;
8010472c:	89 e8                	mov    %ebp,%eax
8010472e:	66 90                	xchg   %ax,%ax
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80104730:	8d 90 00 00 00 80    	lea    -0x80000000(%eax),%edx
80104736:	81 fa fe ff ff 7f    	cmp    $0x7ffffffe,%edx
8010473c:	77 22                	ja     80104760 <acquire+0x80>
    pcs[i] = ebp[1];     // saved %eip
8010473e:	8b 50 04             	mov    0x4(%eax),%edx
80104741:	89 54 b3 0c          	mov    %edx,0xc(%ebx,%esi,4)
  for(i = 0; i < 10; i++){
80104745:	83 c6 01             	add    $0x1,%esi
    ebp = (uint*)ebp[0]; // saved %ebp
80104748:	8b 00                	mov    (%eax),%eax
  for(i = 0; i < 10; i++){
8010474a:	83 fe 0a             	cmp    $0xa,%esi
...
8010475d:	8d 76 00             	lea    0x0(%esi),%esi
  for(; i < 10; i++)
80104760:	8d 44 b3 0c          	lea    0xc(%ebx,%esi,4),%eax
80104764:	83 c3 34             	add    $0x34,%ebx
...
80104787:	68 d5 7a 10 80       	push   $0x80107ad5
...
801047af:	e8 dc fe ff ff       	call   80104690 <holding>
801047b4:	83 c4 10             	add    $0x10,%esp
801047b7:	85 c0                	test   %eax,%eax
801047b9:	74 22                	je     801047dd <release+0x3d>
  lk->pcs[0] = 0;
801047bb:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  lk->cpu = 0;
801047c2:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  __sync_synchronize();
801047c9:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
801047ce:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
}
801047d4:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801047d7:	c9                   	leave  
  popcli();
801047d8:	e9 53 fe ff ff       	jmp    80104630 <popcli>
    panic("release");
801047dd:	83 ec 0c             	sub    $0xc,%esp
801047e0:	68 dd 7a 10 80       	push   $0x80107add
801047e5:	e8 a6 bb ff ff       	call   80100390 <panic>
...
80104804:	09 cf                	or     %ecx,%edi
80104806:	83 e7 03             	and    $0x3,%edi
80104809:	75 25                	jne    80104830 <memset+0x40>
    c &= 0xFF;
8010480b:	0f b6 f8             	movzbl %al,%edi
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
8010480e:	c1 e0 18             	shl    $0x18,%eax
80104811:	89 fb                	mov    %edi,%ebx
80104813:	c1 e9 02             	shr    $0x2,%ecx
80104816:	c1 e3 10             	shl    $0x10,%ebx
...
80104854:	74 2a                	je     80104880 <memcmp+0x40>
80104856:	01 c6                	add    %eax,%esi
80104858:	eb 10                	jmp    8010486a <memcmp+0x2a>
...
8010489f:	8b 75 0c             	mov    0xc(%ebp),%esi
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
801048a2:	39 d6                	cmp    %edx,%esi
801048a4:	73 2a                	jae    801048d0 <memmove+0x40>
801048a6:	8d 3c 0e             	lea    (%esi,%ecx,1),%edi
801048a9:	39 fa                	cmp    %edi,%edx
801048ab:	73 23                	jae    801048d0 <memmove+0x40>
801048ad:	8d 41 ff             	lea    -0x1(%ecx),%eax
    s += n;
    d += n;
    while(n-- > 0)
801048b0:	85 c9                	test   %ecx,%ecx
801048b2:	74 13                	je     801048c7 <memmove+0x37>
801048b4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      *--d = *--s;
801048b8:	0f b6 0c 06          	movzbl (%esi,%eax,1),%ecx
801048bc:	88 0c 02             	mov    %cl,(%edx,%eax,1)
    while(n-- > 0)
801048bf:	83 e8 01             	sub    $0x1,%eax
801048c2:	83 f8 ff             	cmp    $0xffffffff,%eax
...
801048cd:	8d 76 00             	lea    0x0(%esi),%esi
    while(n-- > 0)
801048d0:	8d 04 0e             	lea    (%esi,%ecx,1),%eax
801048d3:	89 d7                	mov    %edx,%edi
801048d5:	85 c9                	test   %ecx,%ecx
801048d7:	74 ee                	je     801048c7 <memmove+0x37>
801048d9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      *d++ = *s++;
801048e0:	a4                   	movsb  %ds:(%esi),%es:(%edi)
    while(n-- > 0)
801048e1:	39 f0                	cmp    %esi,%eax
801048e3:	75 fb                	jne    801048e0 <memmove+0x50>
}
801048e5:	5e                   	pop    %esi
...
801048f4:	eb 9a                	jmp    80104890 <memmove>
...
80104908:	8b 75 10             	mov    0x10(%ebp),%esi
8010490b:	8b 4d 08             	mov    0x8(%ebp),%ecx
8010490e:	53                   	push   %ebx
8010490f:	8b 45 0c             	mov    0xc(%ebp),%eax
  while(n > 0 && *p && *p == *q)
80104912:	85 f6                	test   %esi,%esi
80104914:	74 32                	je     80104948 <strncmp+0x48>
80104916:	01 c6                	add    %eax,%esi
80104918:	eb 14                	jmp    8010492e <strncmp+0x2e>
8010491a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104920:	38 da                	cmp    %bl,%dl
80104922:	75 14                	jne    80104938 <strncmp+0x38>
    n--, p++, q++;
80104924:	83 c0 01             	add    $0x1,%eax
80104927:	83 c1 01             	add    $0x1,%ecx
  while(n > 0 && *p && *p == *q)
8010492a:	39 f0                	cmp    %esi,%eax
8010492c:	74 1a                	je     80104948 <strncmp+0x48>
8010492e:	0f b6 11             	movzbl (%ecx),%edx
80104931:	0f b6 18             	movzbl (%eax),%ebx
80104934:	84 d2                	test   %dl,%dl
80104936:	75 e8                	jne    80104920 <strncmp+0x20>
  if(n == 0)
    return 0;
  return (uchar)*p - (uchar)*q;
80104938:	0f b6 c2             	movzbl %dl,%eax
8010493b:	29 d8                	sub    %ebx,%eax
}
8010493d:	5b                   	pop    %ebx
8010493e:	5e                   	pop    %esi
8010493f:	5d                   	pop    %ebp
...
8010495d:	8b 45 10             	mov    0x10(%ebp),%eax
  ...
  os = s;
  while(n-- > 0 && (*s++ = *t++) != 0)
80104960:	89 f2                	mov    %esi,%edx
80104962:	eb 1b                	jmp    8010497f <strncpy+0x2f>
80104964:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104968:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
8010496c:	8b 7d 0c             	mov    0xc(%ebp),%edi
8010496f:	83 c2 01             	add    $0x1,%edx
80104972:	0f b6 7f ff          	movzbl -0x1(%edi),%edi
80104976:	89 f9                	mov    %edi,%ecx
80104978:	88 4a ff             	mov    %cl,-0x1(%edx)
8010497b:	84 c9                	test   %cl,%cl
8010497d:	74 09                	je     80104988 <strncpy+0x38>
8010497f:	89 c3                	mov    %eax,%ebx
80104981:	83 e8 01             	sub    $0x1,%eax
80104984:	85 db                	test   %ebx,%ebx
80104986:	7f e0                	jg     80104968 <strncpy+0x18>
    ;
  while(n-- > 0)
80104988:	89 d1                	mov    %edx,%ecx
8010498a:	85 c0                	test   %eax,%eax
8010498c:	7e 15                	jle    801049a3 <strncpy+0x53>
8010498e:	66 90                	xchg   %ax,%ax
    *s++ = 0;
80104990:	83 c1 01             	add    $0x1,%ecx
80104993:	c6 41 ff 00          	movb   $0x0,-0x1(%ecx)
  while(n-- > 0)
80104997:	89 c8                	mov    %ecx,%eax
80104999:	f7 d0                	not    %eax
8010499b:	01 d0                	add    %edx,%eax
8010499d:	01 d8                	add    %ebx,%eax
8010499f:	85 c0                	test   %eax,%eax
801049a1:	7f ed                	jg     80104990 <strncpy+0x40>
  return os;
}
801049a3:	5b                   	pop    %ebx
...
801049b8:	8b 55 10             	mov    0x10(%ebp),%edx
801049bb:	8b 75 08             	mov    0x8(%ebp),%esi
...
801049c4:	7e 21                	jle    801049e7 <safestrcpy+0x37>
801049c6:	8d 5c 10 ff          	lea    -0x1(%eax,%edx,1),%ebx
801049ca:	89 f2                	mov    %esi,%edx
801049cc:	eb 12                	jmp    801049e0 <safestrcpy+0x30>
...
801049f9:	8b 55 08             	mov    0x8(%ebp),%edx
  for(n = 0; s[n]; n++)
801049fc:	80 3a 00             	cmpb   $0x0,(%edx)
801049ff:	74 10                	je     80104a11 <strlen+0x21>
80104a01:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80104a08:	83 c0 01             	add    $0x1,%eax
80104a0b:	80 3c 02 00          	cmpb   $0x0,(%edx,%eax,1)
80104a0f:	75 f7                	jne    80104a08 <strlen+0x18>
    ;
  return n;
}
80104a11:	5d                   	pop    %ebp
...
swtch:
  movl 4(%esp), %eax
80104a13:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
80104a17:	8b 54 24 08          	mov    0x8(%esp),%edx
...
80104a1e:	57                   	push   %edi
  ...
  # Switch stacks
  movl %esp, (%eax)
80104a1f:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
80104a21:	89 d4                	mov    %edx,%esp
...
80104a45:	39 d8                	cmp    %ebx,%eax
80104a47:	76 17                	jbe    80104a60 <fetchint+0x30>
80104a49:	8d 53 04             	lea    0x4(%ebx),%edx
80104a4c:	39 d0                	cmp    %edx,%eax
80104a4e:	72 10                	jb     80104a60 <fetchint+0x30>
    return -1;
  *ip = *(int*)(addr);
80104a50:	8b 45 0c             	mov    0xc(%ebp),%eax
80104a53:	8b 13                	mov    (%ebx),%edx
80104a55:	89 10                	mov    %edx,(%eax)
  return 0;
80104a57:	31 c0                	xor    %eax,%eax
}
80104a59:	83 c4 04             	add    $0x4,%esp
80104a5c:	5b                   	pop    %ebx
80104a5d:	5d                   	pop    %ebp
80104a5e:	c3                   	ret    
80104a5f:	90                   	nop
...
80104a65:	eb f2                	jmp    80104a59 <fetchint+0x29>
...
80104a7b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
80104a7e:	e8 dd ee ff ff       	call   80103960 <myproc>

  if(addr >= curproc->sz)
80104a83:	39 18                	cmp    %ebx,(%eax)
80104a85:	76 31                	jbe    80104ab8 <fetchstr+0x48>
    return -1;
  *pp = (char*)addr;
...
80104a90:	73 26                	jae    80104ab8 <fetchstr+0x48>
80104a92:	89 d8                	mov    %ebx,%eax
80104a94:	eb 11                	jmp    80104aa7 <fetchstr+0x37>
...
80104aa5:	76 11                	jbe    80104ab8 <fetchstr+0x48>
    if(*s == 0)
80104aa7:	80 38 00             	cmpb   $0x0,(%eax)
80104aaa:	75 f4                	jne    80104aa0 <fetchstr+0x30>
      return s - *pp;
  }
  return -1;
}
80104aac:	83 c4 04             	add    $0x4,%esp
      return s - *pp;
80104aaf:	29 d8                	sub    %ebx,%eax
}
80104ab1:	5b                   	pop    %ebx
80104ab2:	5d                   	pop    %ebp
80104ab3:	c3                   	ret    
80104ab4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104ab8:	83 c4 04             	add    $0x4,%esp
    return -1;
...
80104ad9:	e8 82 ee ff ff       	call   80103960 <myproc>
80104ade:	8b 55 08             	mov    0x8(%ebp),%edx
80104ae1:	8b 40 18             	mov    0x18(%eax),%eax
80104ae4:	8b 40 44             	mov    0x44(%eax),%eax
80104ae7:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104aea:	e8 71 ee ff ff       	call   80103960 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104aef:	8d 73 04             	lea    0x4(%ebx),%esi
  if(addr >= curproc->sz || addr+4 > curproc->sz)
80104af2:	8b 00                	mov    (%eax),%eax
...
80104b29:	83 ec 10             	sub    $0x10,%esp
80104b2c:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
80104b2f:	e8 2c ee ff ff       	call   80103960 <myproc>
 
  if(argint(n, &i) < 0)
80104b34:	83 ec 08             	sub    $0x8,%esp
  struct proc *curproc = myproc();
80104b37:	89 c6                	mov    %eax,%esi
  if(argint(n, &i) < 0)
80104b39:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104b3c:	50                   	push   %eax
80104b3d:	ff 75 08             	pushl  0x8(%ebp)
80104b40:	e8 8b ff ff ff       	call   80104ad0 <argint>
    return -1;
...
80104b4e:	78 20                	js     80104b70 <argptr+0x50>
80104b50:	8b 16                	mov    (%esi),%edx
80104b52:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b55:	39 c2                	cmp    %eax,%edx
80104b57:	76 17                	jbe    80104b70 <argptr+0x50>
80104b59:	01 c3                	add    %eax,%ebx
80104b5b:	39 da                	cmp    %ebx,%edx
80104b5d:	72 11                	jb     80104b70 <argptr+0x50>
    return -1;
  *pp = (char*)i;
80104b5f:	8b 55 0c             	mov    0xc(%ebp),%edx
80104b62:	89 02                	mov    %eax,(%edx)
  return 0;
80104b64:	31 c0                	xor    %eax,%eax
}
...
80104b75:	eb ef                	jmp    80104b66 <argptr+0x46>
...
80104b87:	83 ec 20             	sub    $0x20,%esp
  int addr;
  if(argint(n, &addr) < 0)
80104b8a:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104b8d:	50                   	push   %eax
80104b8e:	ff 75 08             	pushl  0x8(%ebp)
80104b91:	e8 3a ff ff ff       	call   80104ad0 <argint>
80104b96:	83 c4 10             	add    $0x10,%esp
80104b99:	85 c0                	test   %eax,%eax
80104b9b:	78 13                	js     80104bb0 <argstr+0x30>
    return -1;
  return fetchstr(addr, pp);
80104b9d:	83 ec 08             	sub    $0x8,%esp
80104ba0:	ff 75 0c             	pushl  0xc(%ebp)
80104ba3:	ff 75 f4             	pushl  -0xc(%ebp)
80104ba6:	e8 c5 fe ff ff       	call   80104a70 <fetchstr>
...
80104bc8:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104bcb:	e8 90 ed ff ff       	call   80103960 <myproc>
80104bd0:	89 c3                	mov    %eax,%ebx

  num = curproc->tf->eax;
80104bd2:	8b 40 18             	mov    0x18(%eax),%eax
80104bd5:	8b 40 1c             	mov    0x1c(%eax),%eax
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104bd8:	8d 50 ff             	lea    -0x1(%eax),%edx
80104bdb:	83 fa 1b             	cmp    $0x1b,%edx
80104bde:	77 20                	ja     80104c00 <syscall+0x40>
80104be0:	8b 14 85 20 7b 10 80 	mov    -0x7fef84e0(,%eax,4),%edx
80104be7:	85 d2                	test   %edx,%edx
80104be9:	74 15                	je     80104c00 <syscall+0x40>
    curproc->tf->eax = syscalls[num]();
80104beb:	ff d2                	call   *%edx
80104bed:	89 c2                	mov    %eax,%edx
80104bef:	8b 43 18             	mov    0x18(%ebx),%eax
80104bf2:	89 50 1c             	mov    %edx,0x1c(%eax)
  } else {
...
80104c05:	ff 73 10             	pushl  0x10(%ebx)
80104c08:	68 e5 7a 10 80       	push   $0x80107ae5
...
80104d64:	68 b0 7b 10 80       	push   $0x80107bb0
...
80104d7c:	68 af 7b 10 80       	push   $0x80107baf
...
80104d91:	68 a3 7b 10 80       	push   $0x80107ba3
...
80104daf:	68 b2 7b 10 80       	push   $0x80107bb2
80104db4:	e8 d7 b5 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104db9:	83 ec 0c             	sub    $0xc,%esp
80104dbc:	68 94 7b 10 80       	push   $0x80107b94
...
80104de2:	e8 e9 fc ff ff       	call   80104ad0 <argint>
...
80104df4:	e8 67 eb ff ff       	call   80103960 <myproc>
...
80104eb1:	e8 1a fc ff ff       	call   80104ad0 <argint>
...
80104ec9:	e8 52 fc ff ff       	call   80104b20 <argptr>
...
80104f21:	e8 aa fb ff ff       	call   80104ad0 <argint>
...
80104f39:	e8 e2 fb ff ff       	call   80104b20 <argptr>
...
80104f87:	78 27                	js     80104fb0 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104f89:	e8 d2 e9 ff ff       	call   80103960 <myproc>
...
80104fe3:	e8 38 fb ff ff       	call   80104b20 <argptr>
...
80105023:	e8 58 fb ff ff       	call   80104b80 <argstr>
...
8010503c:	e8 3f fb ff ff       	call   80104b80 <argstr>
...
80105173:	e8 08 fa ff ff       	call   80104b80 <argstr>
...
801051ad:	58                   	pop    %eax
801051ae:	5a                   	pop    %edx
801051af:	68 b0 7b 10 80       	push   $0x80107bb0
...
801051c8:	68 af 7b 10 80       	push   $0x80107baf
...
80105353:	e8 28 f8 ff ff       	call   80104b80 <argstr>
...
8010536c:	e8 5f f7 ff ff       	call   80104ad0 <argint>
...
801053b7:	74 23                	je     801053dc <sys_open+0x9c>
  struct proc *curproc = myproc();
801053b9:	e8 a2 e5 ff ff       	call   80103960 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105498:	e8 e3 f6 ff ff       	call   80104b80 <argstr>
...
80105508:	e8 73 f6 ff ff       	call   80104b80 <argstr>
...
8010551d:	e8 ae f5 ff ff       	call   80104ad0 <argint>
  if((argstr(0, &path)) < 0 ||
...
80105532:	e8 99 f5 ff ff       	call   80104ad0 <argint>
     argint(1, &major) < 0 ||
...
80105599:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
8010559c:	e8 bf e3 ff ff       	call   80103960 <myproc>
...
801055b1:	e8 ca f5 ff ff       	call   80104b80 <argstr>
...
80105659:	e8 22 f5 ff ff       	call   80104b80 <argstr>
...
80105675:	e8 56 f4 ff ff       	call   80104ad0 <argint>
...
8010569a:	e8 51 f1 ff ff       	call   801047f0 <memset>
...
801056bc:	e8 6f f3 ff ff       	call   80104a30 <fetchint>
...
801056e0:	e8 8b f3 ff ff       	call   80104a70 <fetchstr>
...
80105755:	e8 c6 f3 ff ff       	call   80104b20 <argptr>
...
8010577b:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
8010577d:	e8 de e1 ff ff       	call   80103960 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801057c7:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
801057ca:	e8 91 e1 ff ff       	call   80103960 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105820:	f3 0f 1e fb          	endbr32 
  return fork();
80105824:	e9 e7 e2 ff ff       	jmp    80103b10 <fork>
...
80105837:	83 ec 08             	sub    $0x8,%esp
  exit();
8010583a:	e8 51 e5 ff ff       	call   80103d90 <exit>
...
80105850:	f3 0f 1e fb          	endbr32 
  return wait();
80105854:	e9 87 e7 ff ff       	jmp    80103fe0 <wait>
...
80105870:	e8 5b f2 ff ff       	call   80104ad0 <argint>
...
80105882:	e8 b9 e8 ff ff       	call   80104140 <kill>
...
801058db:	78 23                	js     80105900 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
801058dd:	e8 7e e0 ff ff       	call   80103960 <myproc>
  if(growproc(n) < 0)
...
801058ea:	e8 a1 e1 ff ff       	call   80103a90 <growproc>
...
80105934:	68 60 4c 11 80       	push   $0x80114c60
80105939:	e8 a2 ed ff ff       	call   801046e0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010593e:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105941:	8b 1d a0 54 11 80    	mov    0x801154a0,%ebx
  while(ticks - ticks0 < n){
...
80105958:	68 a0 54 11 80       	push   $0x801154a0
8010595d:	e8 be e5 ff ff       	call   80103f20 <sleep>
  while(ticks - ticks0 < n){
80105962:	a1 a0 54 11 80       	mov    0x801154a0,%eax
...
8010596f:	73 2f                	jae    801059a0 <sys_sleep+0x90>
    if(myproc()->killed){
80105971:	e8 ea df ff ff       	call   80103960 <myproc>
...
80105980:	68 60 4c 11 80       	push   $0x80114c60
80105985:	e8 16 ee ff ff       	call   801047a0 <release>
  }
  release(&tickslock);
  return 0;
}
...
801059a8:	e8 f3 ed ff ff       	call   801047a0 <release>
  return 0;
...
801059c8:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
801059cb:	68 60 4c 11 80       	push   $0x80114c60
801059d0:	e8 0b ed ff ff       	call   801046e0 <acquire>
  xticks = ticks;
801059d5:	8b 1d a0 54 11 80    	mov    0x801154a0,%ebx
  release(&tickslock);
801059db:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
801059e2:	e8 b9 ed ff ff       	call   801047a0 <release>
  return xticks;
}
...
// For processes that can run in kernel mode
// PA1
int sys_hello(void)
{
...
801059f7:	83 ec 14             	sub    $0x14,%esp
  cprintf("Hello\n");
801059fa:	68 f5 7b 10 80       	push   $0x80107bf5
801059ff:	e8 ac ac ff ff       	call   801006b0 <cprintf>
  return 0;
}
...
80105a17:	83 ec 20             	sub    $0x20,%esp
  char *name;
  argstr(0, &name);
80105a1a:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105a1d:	50                   	push   %eax
80105a1e:	6a 00                	push   $0x0
80105a20:	e8 5b f1 ff ff       	call   80104b80 <argstr>
  cprintf("%s\n", name);
80105a25:	58                   	pop    %eax
80105a26:	5a                   	pop    %edx
80105a27:	ff 75 f4             	pushl  -0xc(%ebp)
80105a2a:	68 fc 7b 10 80       	push   $0x80107bfc
80105a2f:	e8 7c ac ff ff       	call   801006b0 <cprintf>
  return 0;
}
...
80105a40 <sys_getNumProc>:

int sys_getNumProc(void)
{
80105a40:	f3 0f 1e fb          	endbr32 
  return getNumProc();
80105a44:	e9 57 e8 ff ff       	jmp    801042a0 <getNumProc>
80105a49:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

80105a50 <sys_showAncestry>:
}

int sys_showAncestry(void)
{
...
80105a57:	83 ec 08             	sub    $0x8,%esp
  showAncestry();
80105a5a:	e8 71 e8 ff ff       	call   801042d0 <showAncestry>
  return 0;
}
...
80105a70:	f3 0f 1e fb          	endbr32 
  return numvp();
80105a74:	e9 a7 e8 ff ff       	jmp    80104320 <numvp>
...
80105a80:	f3 0f 1e fb          	endbr32 
  return numpp();
80105a84:	e9 d7 e8 ff ff       	jmp    80104360 <numpp>
80105a89:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

80105a90 <sys_mmap>:
}

// Copied from sys_sbrk()
int sys_mmap(void)
{
...
80105aa0:	e8 2b f0 ff ff       	call   80104ad0 <argint>
80105aa5:	83 c4 10             	add    $0x10,%esp
80105aa8:	89 c2                	mov    %eax,%edx
    return 0;
80105aaa:	31 c0                	xor    %eax,%eax
  if(argint(0, &size) < 0)
80105aac:	85 d2                	test   %edx,%edx
80105aae:	78 0f                	js     80105abf <sys_mmap+0x2f>
  if (size < 0 || size % PGSIZE != 0)
80105ab0:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105ab3:	85 d2                	test   %edx,%edx
80105ab5:	78 08                	js     80105abf <sys_mmap+0x2f>
80105ab7:	f7 c2 ff 0f 00 00    	test   $0xfff,%edx
80105abd:	74 09                	je     80105ac8 <sys_mmap+0x38>
    return 0;
  return mmap(size);
80105abf:	c9                   	leave  
80105ac0:	c3                   	ret    
...
80105acb:	52                   	push   %edx
80105acc:	e8 1f e9 ff ff       	call   801043f0 <mmap>
...
80105ad7:	06                   	push   %es
  pushl %fs
80105ad8:	0f a0                	push   %fs
  pushl %gs
80105ada:	0f a8                	push   %gs
  pushal
80105adc:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105add:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105ae1:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105ae3:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105ae5:	54                   	push   %esp
  call trap
80105ae6:	e8 c5 00 00 00       	call   80105bb0 <trap>
  addl $4, %esp
80105aeb:	83 c4 04             	add    $0x4,%esp
...
80105aee:	61                   	popa   
  popl %gs
80105aef:	0f a9                	pop    %gs
  popl %fs
80105af1:	0f a1                	pop    %fs
  popl %es
80105af3:	07                   	pop    %es
  popl %ds
80105af4:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80105af5:	83 c4 08             	add    $0x8,%esp
  iret
80105af8:	cf                   	iret   
...
80105b17:	c7 04 c5 a2 4c 11 80 	movl   $0x8e000008,-0x7feeb35e(,%eax,8)
80105b1e:	08 00 00 8e 
80105b22:	66 89 14 c5 a0 4c 11 	mov    %dx,-0x7feeb360(,%eax,8)
80105b29:	80 
80105b2a:	c1 ea 10             	shr    $0x10,%edx
80105b2d:	66 89 14 c5 a6 4c 11 	mov    %dx,-0x7feeb35a(,%eax,8)
80105b34:	80 
  for(i = 0; i < 256; i++)
...
80105b47:	c7 05 a2 4e 11 80 08 	movl   $0xef000008,0x80114ea2
80105b4e:	00 00 ef 
  initlock(&tickslock, "time");
80105b51:	68 00 7c 10 80       	push   $0x80107c00
80105b56:	68 60 4c 11 80       	push   $0x80114c60
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105b5b:	66 a3 a0 4e 11 80    	mov    %ax,0x80114ea0
80105b61:	c1 e8 10             	shr    $0x10,%eax
80105b64:	66 a3 a6 4e 11 80    	mov    %ax,0x80114ea6
  initlock(&tickslock, "time");
80105b6a:	e8 f1 e9 ff ff       	call   80104560 <initlock>
}
...
80105b8f:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105b93:	b8 a0 4c 11 80       	mov    $0x80114ca0,%eax
...
80105bc6:	0f 84 0c 02 00 00    	je     80105dd8 <trap+0x228>
  ...
  switch(tf->trapno){
80105bcc:	83 e8 0e             	sub    $0xe,%eax
80105bcf:	83 f8 31             	cmp    $0x31,%eax
80105bd2:	77 08                	ja     80105bdc <trap+0x2c>
80105bd4:	3e ff 24 85 d8 7c 10 	notrack jmp *-0x7fef8328(,%eax,4)
80105bdb:	80 
    switchuvm(myproc());
    break;
...
80105bdc:	e8 7f dd ff ff       	call   80103960 <myproc>
80105be1:	85 c0                	test   %eax,%eax
80105be3:	0f 84 3e 02 00 00    	je     80105e27 <trap+0x277>
80105be9:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105bed:	0f 84 34 02 00 00    	je     80105e27 <trap+0x277>
...
80105bf6:	8b 53 38             	mov    0x38(%ebx),%edx
80105bf9:	89 4d d8             	mov    %ecx,-0x28(%ebp)
80105bfc:	89 55 dc             	mov    %edx,-0x24(%ebp)
80105bff:	e8 3c dd ff ff       	call   80103940 <cpuid>
80105c04:	8b 73 30             	mov    0x30(%ebx),%esi
80105c07:	89 c7                	mov    %eax,%edi
80105c09:	8b 43 34             	mov    0x34(%ebx),%eax
80105c0c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
80105c0f:	e8 4c dd ff ff       	call   80103960 <myproc>
80105c14:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105c17:	e8 44 dd ff ff       	call   80103960 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105c1c:	8b 4d d8             	mov    -0x28(%ebp),%ecx
80105c1f:	8b 55 dc             	mov    -0x24(%ebp),%edx
80105c22:	51                   	push   %ecx
80105c23:	52                   	push   %edx
80105c24:	57                   	push   %edi
80105c25:	ff 75 e4             	pushl  -0x1c(%ebp)
80105c28:	56                   	push   %esi
            myproc()->pid, myproc()->name, tf->trapno,
80105c29:	8b 75 e0             	mov    -0x20(%ebp),%esi
80105c2c:	83 c6 6c             	add    $0x6c,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105c2f:	56                   	push   %esi
80105c30:	ff 70 10             	pushl  0x10(%eax)
80105c33:	68 94 7c 10 80       	push   $0x80107c94
80105c38:	e8 73 aa ff ff       	call   801006b0 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
80105c3d:	83 c4 20             	add    $0x20,%esp
80105c40:	e8 1b dd ff ff       	call   80103960 <myproc>
80105c45:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  }
...
80105c53:	74 1d                	je     80105c72 <trap+0xc2>
80105c55:	e8 06 dd ff ff       	call   80103960 <myproc>
80105c5a:	8b 50 24             	mov    0x24(%eax),%edx
80105c5d:	85 d2                	test   %edx,%edx
80105c5f:	74 11                	je     80105c72 <trap+0xc2>
80105c61:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105c65:	83 e0 03             	and    $0x3,%eax
80105c68:	66 83 f8 03          	cmp    $0x3,%ax
80105c6c:	0f 84 9e 01 00 00    	je     80105e10 <trap+0x260>
    exit();
...
80105c79:	74 0f                	je     80105c8a <trap+0xda>
80105c7b:	e8 e0 dc ff ff       	call   80103960 <myproc>
80105c80:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105c84:	0f 84 36 01 00 00    	je     80105dc0 <trap+0x210>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c8a:	e8 d1 dc ff ff       	call   80103960 <myproc>
80105c8f:	85 c0                	test   %eax,%eax
80105c91:	74 1d                	je     80105cb0 <trap+0x100>
80105c93:	e8 c8 dc ff ff       	call   80103960 <myproc>
80105c98:	8b 40 24             	mov    0x24(%eax),%eax
80105c9b:	85 c0                	test   %eax,%eax
80105c9d:	74 11                	je     80105cb0 <trap+0x100>
80105c9f:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105ca3:	83 e0 03             	and    $0x3,%eax
80105ca6:	66 83 f8 03          	cmp    $0x3,%ax
80105caa:	0f 84 51 01 00 00    	je     80105e01 <trap+0x251>
    exit();
}
...
80105cb7:	c3                   	ret    
    ideintr();
80105cb8:	e8 23 c5 ff ff       	call   801021e0 <ideintr>
    lapiceoi();
80105cbd:	e8 fe cb ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105cc2:	e8 99 dc ff ff       	call   80103960 <myproc>
80105cc7:	85 c0                	test   %eax,%eax
80105cc9:	75 8a                	jne    80105c55 <trap+0xa5>
80105ccb:	eb a5                	jmp    80105c72 <trap+0xc2>
80105ccd:	0f 20 d6             	mov    %cr2,%esi
    cprintf("Page Fault Handler (1 = success, 0 = fail): %d\n", page_fault_handler(myproc()->pgdir, PGROUNDDOWN(rcr2())));
80105cd0:	e8 8b dc ff ff       	call   80103960 <myproc>
80105cd5:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
80105cdb:	83 ec 08             	sub    $0x8,%esp
80105cde:	56                   	push   %esi
80105cdf:	ff 70 04             	pushl  0x4(%eax)
80105ce2:	e8 b9 16 00 00       	call   801073a0 <page_fault_handler>
80105ce7:	59                   	pop    %ecx
80105ce8:	5e                   	pop    %esi
80105ce9:	50                   	push   %eax
80105cea:	68 30 7c 10 80       	push   $0x80107c30
80105cef:	e8 bc a9 ff ff       	call   801006b0 <cprintf>
    switchuvm(myproc());
80105cf4:	e8 67 dc ff ff       	call   80103960 <myproc>
80105cf9:	89 04 24             	mov    %eax,(%esp)
80105cfc:	e8 cf 0f 00 00       	call   80106cd0 <switchuvm>
    break;
80105d01:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105d04:	e8 57 dc ff ff       	call   80103960 <myproc>
80105d09:	85 c0                	test   %eax,%eax
80105d0b:	0f 85 44 ff ff ff    	jne    80105c55 <trap+0xa5>
80105d11:	e9 5c ff ff ff       	jmp    80105c72 <trap+0xc2>
    if(cpuid() == 0){
80105d16:	e8 25 dc ff ff       	call   80103940 <cpuid>
80105d1b:	85 c0                	test   %eax,%eax
80105d1d:	75 9e                	jne    80105cbd <trap+0x10d>
      acquire(&tickslock);
80105d1f:	83 ec 0c             	sub    $0xc,%esp
80105d22:	68 60 4c 11 80       	push   $0x80114c60
80105d27:	e8 b4 e9 ff ff       	call   801046e0 <acquire>
      wakeup(&ticks);
80105d2c:	c7 04 24 a0 54 11 80 	movl   $0x801154a0,(%esp)
      ticks++;
80105d33:	83 05 a0 54 11 80 01 	addl   $0x1,0x801154a0
      wakeup(&ticks);
80105d3a:	e8 a1 e3 ff ff       	call   801040e0 <wakeup>
      release(&tickslock);
80105d3f:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
80105d46:	e8 55 ea ff ff       	call   801047a0 <release>
80105d4b:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
80105d4e:	e9 6a ff ff ff       	jmp    80105cbd <trap+0x10d>
    kbdintr();
80105d53:	e8 28 ca ff ff       	call   80102780 <kbdintr>
    lapiceoi();
80105d58:	e8 63 cb ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105d5d:	e8 fe db ff ff       	call   80103960 <myproc>
80105d62:	85 c0                	test   %eax,%eax
80105d64:	0f 85 eb fe ff ff    	jne    80105c55 <trap+0xa5>
80105d6a:	e9 03 ff ff ff       	jmp    80105c72 <trap+0xc2>
    uartintr();
80105d6f:	e8 5c 02 00 00       	call   80105fd0 <uartintr>
    lapiceoi();
80105d74:	e8 47 cb ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105d79:	e8 e2 db ff ff       	call   80103960 <myproc>
80105d7e:	85 c0                	test   %eax,%eax
80105d80:	0f 85 cf fe ff ff    	jne    80105c55 <trap+0xa5>
80105d86:	e9 e7 fe ff ff       	jmp    80105c72 <trap+0xc2>
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105d8b:	8b 7b 38             	mov    0x38(%ebx),%edi
80105d8e:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80105d92:	e8 a9 db ff ff       	call   80103940 <cpuid>
80105d97:	57                   	push   %edi
80105d98:	56                   	push   %esi
80105d99:	50                   	push   %eax
80105d9a:	68 0c 7c 10 80       	push   $0x80107c0c
80105d9f:	e8 0c a9 ff ff       	call   801006b0 <cprintf>
    lapiceoi();
80105da4:	e8 17 cb ff ff       	call   801028c0 <lapiceoi>
    break;
80105da9:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105dac:	e8 af db ff ff       	call   80103960 <myproc>
80105db1:	85 c0                	test   %eax,%eax
80105db3:	0f 85 9c fe ff ff    	jne    80105c55 <trap+0xa5>
80105db9:	e9 b4 fe ff ff       	jmp    80105c72 <trap+0xc2>
80105dbe:	66 90                	xchg   %ax,%ax
  if(myproc() && myproc()->state == RUNNING &&
80105dc0:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80105dc4:	0f 85 c0 fe ff ff    	jne    80105c8a <trap+0xda>
    yield();
80105dca:	e8 01 e1 ff ff       	call   80103ed0 <yield>
80105dcf:	e9 b6 fe ff ff       	jmp    80105c8a <trap+0xda>
80105dd4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(myproc()->killed)
80105dd8:	e8 83 db ff ff       	call   80103960 <myproc>
80105ddd:	8b 40 24             	mov    0x24(%eax),%eax
80105de0:	85 c0                	test   %eax,%eax
80105de2:	75 3c                	jne    80105e20 <trap+0x270>
    myproc()->tf = tf;
80105de4:	e8 77 db ff ff       	call   80103960 <myproc>
80105de9:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105dec:	e8 cf ed ff ff       	call   80104bc0 <syscall>
    if(myproc()->killed)
80105df1:	e8 6a db ff ff       	call   80103960 <myproc>
80105df6:	8b 78 24             	mov    0x24(%eax),%edi
80105df9:	85 ff                	test   %edi,%edi
80105dfb:	0f 84 af fe ff ff    	je     80105cb0 <trap+0x100>
}
...
80105e07:	5d                   	pop    %ebp
      exit();
80105e08:	e9 83 df ff ff       	jmp    80103d90 <exit>
80105e0d:	8d 76 00             	lea    0x0(%esi),%esi
    exit();
80105e10:	e8 7b df ff ff       	call   80103d90 <exit>
80105e15:	e9 58 fe ff ff       	jmp    80105c72 <trap+0xc2>
80105e1a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105e20:	e8 6b df ff ff       	call   80103d90 <exit>
80105e25:	eb bd                	jmp    80105de4 <trap+0x234>
80105e27:	0f 20 d7             	mov    %cr2,%edi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105e2a:	8b 73 38             	mov    0x38(%ebx),%esi
80105e2d:	e8 0e db ff ff       	call   80103940 <cpuid>
80105e32:	83 ec 0c             	sub    $0xc,%esp
80105e35:	57                   	push   %edi
80105e36:	56                   	push   %esi
80105e37:	50                   	push   %eax
80105e38:	ff 73 30             	pushl  0x30(%ebx)
80105e3b:	68 60 7c 10 80       	push   $0x80107c60
80105e40:	e8 6b a8 ff ff       	call   801006b0 <cprintf>
      panic("trap");
80105e45:	83 c4 14             	add    $0x14,%esp
80105e48:	68 05 7c 10 80       	push   $0x80107c05
80105e4d:	e8 3e a5 ff ff       	call   80100390 <panic>
80105e52:	66 90                	xchg   %ax,%ax
80105e54:	66 90                	xchg   %ax,%ax
80105e56:	66 90                	xchg   %ax,%ax
80105e58:	66 90                	xchg   %ax,%ax
...
80105f53:	be 76 00 00 00       	mov    $0x76,%esi
  for(p="xv6...\n"; *p; p++)
80105f58:	bb a0 7d 10 80       	mov    $0x80107da0,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80105feb:	6a 00                	push   $0x0
  jmp alltraps
80105fed:	e9 e4 fa ff ff       	jmp    80105ad6 <alltraps>
...
80105ff4:	6a 01                	push   $0x1
  jmp alltraps
80105ff6:	e9 db fa ff ff       	jmp    80105ad6 <alltraps>
...
80105ffd:	6a 02                	push   $0x2
  jmp alltraps
80105fff:	e9 d2 fa ff ff       	jmp    80105ad6 <alltraps>
...
80106006:	6a 03                	push   $0x3
  jmp alltraps
80106008:	e9 c9 fa ff ff       	jmp    80105ad6 <alltraps>
...
8010600f:	6a 04                	push   $0x4
  jmp alltraps
80106011:	e9 c0 fa ff ff       	jmp    80105ad6 <alltraps>
...
80106018:	6a 05                	push   $0x5
  jmp alltraps
8010601a:	e9 b7 fa ff ff       	jmp    80105ad6 <alltraps>
...
80106021:	6a 06                	push   $0x6
  jmp alltraps
80106023:	e9 ae fa ff ff       	jmp    80105ad6 <alltraps>
...
8010602a:	6a 07                	push   $0x7
  jmp alltraps
8010602c:	e9 a5 fa ff ff       	jmp    80105ad6 <alltraps>
...
80106031:	6a 08                	push   $0x8
  jmp alltraps
80106033:	e9 9e fa ff ff       	jmp    80105ad6 <alltraps>
...
8010603a:	6a 09                	push   $0x9
  jmp alltraps
8010603c:	e9 95 fa ff ff       	jmp    80105ad6 <alltraps>
...
80106041:	6a 0a                	push   $0xa
  jmp alltraps
80106043:	e9 8e fa ff ff       	jmp    80105ad6 <alltraps>
...
80106048:	6a 0b                	push   $0xb
  jmp alltraps
8010604a:	e9 87 fa ff ff       	jmp    80105ad6 <alltraps>
...
8010604f:	6a 0c                	push   $0xc
  jmp alltraps
80106051:	e9 80 fa ff ff       	jmp    80105ad6 <alltraps>
...
80106056:	6a 0d                	push   $0xd
  jmp alltraps
80106058:	e9 79 fa ff ff       	jmp    80105ad6 <alltraps>
...
8010605d:	6a 0e                	push   $0xe
  jmp alltraps
8010605f:	e9 72 fa ff ff       	jmp    80105ad6 <alltraps>
...
80106066:	6a 0f                	push   $0xf
  jmp alltraps
80106068:	e9 69 fa ff ff       	jmp    80105ad6 <alltraps>
...
8010606f:	6a 10                	push   $0x10
  jmp alltraps
80106071:	e9 60 fa ff ff       	jmp    80105ad6 <alltraps>
...
80106076:	6a 11                	push   $0x11
  jmp alltraps
80106078:	e9 59 fa ff ff       	jmp    80105ad6 <alltraps>
...
8010607f:	6a 12                	push   $0x12
  jmp alltraps
80106081:	e9 50 fa ff ff       	jmp    80105ad6 <alltraps>
...
80106088:	6a 13                	push   $0x13
  jmp alltraps
8010608a:	e9 47 fa ff ff       	jmp    80105ad6 <alltraps>
...
80106091:	6a 14                	push   $0x14
  jmp alltraps
80106093:	e9 3e fa ff ff       	jmp    80105ad6 <alltraps>
...
8010609a:	6a 15                	push   $0x15
  jmp alltraps
8010609c:	e9 35 fa ff ff       	jmp    80105ad6 <alltraps>
...
801060a3:	6a 16                	push   $0x16
  jmp alltraps
801060a5:	e9 2c fa ff ff       	jmp    80105ad6 <alltraps>
...
801060ac:	6a 17                	push   $0x17
  jmp alltraps
801060ae:	e9 23 fa ff ff       	jmp    80105ad6 <alltraps>
...
801060b5:	6a 18                	push   $0x18
  jmp alltraps
801060b7:	e9 1a fa ff ff       	jmp    80105ad6 <alltraps>
...
801060be:	6a 19                	push   $0x19
  jmp alltraps
801060c0:	e9 11 fa ff ff       	jmp    80105ad6 <alltraps>
...
801060c7:	6a 1a                	push   $0x1a
  jmp alltraps
801060c9:	e9 08 fa ff ff       	jmp    80105ad6 <alltraps>
...
801060d0:	6a 1b                	push   $0x1b
  jmp alltraps
801060d2:	e9 ff f9 ff ff       	jmp    80105ad6 <alltraps>
...
801060d9:	6a 1c                	push   $0x1c
  jmp alltraps
801060db:	e9 f6 f9 ff ff       	jmp    80105ad6 <alltraps>
...
801060e2:	6a 1d                	push   $0x1d
  jmp alltraps
801060e4:	e9 ed f9 ff ff       	jmp    80105ad6 <alltraps>
...
801060eb:	6a 1e                	push   $0x1e
  jmp alltraps
801060ed:	e9 e4 f9 ff ff       	jmp    80105ad6 <alltraps>
...
801060f4:	6a 1f                	push   $0x1f
  jmp alltraps
801060f6:	e9 db f9 ff ff       	jmp    80105ad6 <alltraps>
...
801060fd:	6a 20                	push   $0x20
  jmp alltraps
801060ff:	e9 d2 f9 ff ff       	jmp    80105ad6 <alltraps>
...
80106106:	6a 21                	push   $0x21
  jmp alltraps
80106108:	e9 c9 f9 ff ff       	jmp    80105ad6 <alltraps>
...
8010610f:	6a 22                	push   $0x22
  jmp alltraps
80106111:	e9 c0 f9 ff ff       	jmp    80105ad6 <alltraps>
...
80106118:	6a 23                	push   $0x23
  jmp alltraps
8010611a:	e9 b7 f9 ff ff       	jmp    80105ad6 <alltraps>
...
80106121:	6a 24                	push   $0x24
  jmp alltraps
80106123:	e9 ae f9 ff ff       	jmp    80105ad6 <alltraps>
...
8010612a:	6a 25                	push   $0x25
  jmp alltraps
8010612c:	e9 a5 f9 ff ff       	jmp    80105ad6 <alltraps>
...
80106133:	6a 26                	push   $0x26
  jmp alltraps
80106135:	e9 9c f9 ff ff       	jmp    80105ad6 <alltraps>
...
8010613c:	6a 27                	push   $0x27
  jmp alltraps
8010613e:	e9 93 f9 ff ff       	jmp    80105ad6 <alltraps>
...
80106145:	6a 28                	push   $0x28
  jmp alltraps
80106147:	e9 8a f9 ff ff       	jmp    80105ad6 <alltraps>
...
8010614e:	6a 29                	push   $0x29
  jmp alltraps
80106150:	e9 81 f9 ff ff       	jmp    80105ad6 <alltraps>
...
80106157:	6a 2a                	push   $0x2a
  jmp alltraps
80106159:	e9 78 f9 ff ff       	jmp    80105ad6 <alltraps>
...
80106160:	6a 2b                	push   $0x2b
  jmp alltraps
80106162:	e9 6f f9 ff ff       	jmp    80105ad6 <alltraps>
...
80106169:	6a 2c                	push   $0x2c
  jmp alltraps
8010616b:	e9 66 f9 ff ff       	jmp    80105ad6 <alltraps>
...
80106172:	6a 2d                	push   $0x2d
  jmp alltraps
80106174:	e9 5d f9 ff ff       	jmp    80105ad6 <alltraps>
...
8010617b:	6a 2e                	push   $0x2e
  jmp alltraps
8010617d:	e9 54 f9 ff ff       	jmp    80105ad6 <alltraps>
...
80106184:	6a 2f                	push   $0x2f
  jmp alltraps
80106186:	e9 4b f9 ff ff       	jmp    80105ad6 <alltraps>
...
8010618d:	6a 30                	push   $0x30
  jmp alltraps
8010618f:	e9 42 f9 ff ff       	jmp    80105ad6 <alltraps>
...
80106196:	6a 31                	push   $0x31
  jmp alltraps
80106198:	e9 39 f9 ff ff       	jmp    80105ad6 <alltraps>
...
8010619f:	6a 32                	push   $0x32
  jmp alltraps
801061a1:	e9 30 f9 ff ff       	jmp    80105ad6 <alltraps>
...
801061a8:	6a 33                	push   $0x33
  jmp alltraps
801061aa:	e9 27 f9 ff ff       	jmp    80105ad6 <alltraps>
...
801061b1:	6a 34                	push   $0x34
  jmp alltraps
801061b3:	e9 1e f9 ff ff       	jmp    80105ad6 <alltraps>
...
801061ba:	6a 35                	push   $0x35
  jmp alltraps
801061bc:	e9 15 f9 ff ff       	jmp    80105ad6 <alltraps>
...
801061c3:	6a 36                	push   $0x36
  jmp alltraps
801061c5:	e9 0c f9 ff ff       	jmp    80105ad6 <alltraps>
...
801061cc:	6a 37                	push   $0x37
  jmp alltraps
801061ce:	e9 03 f9 ff ff       	jmp    80105ad6 <alltraps>
...
801061d5:	6a 38                	push   $0x38
  jmp alltraps
801061d7:	e9 fa f8 ff ff       	jmp    80105ad6 <alltraps>
...
801061de:	6a 39                	push   $0x39
  jmp alltraps
801061e0:	e9 f1 f8 ff ff       	jmp    80105ad6 <alltraps>
...
801061e7:	6a 3a                	push   $0x3a
  jmp alltraps
801061e9:	e9 e8 f8 ff ff       	jmp    80105ad6 <alltraps>
...
801061f0:	6a 3b                	push   $0x3b
  jmp alltraps
801061f2:	e9 df f8 ff ff       	jmp    80105ad6 <alltraps>
...
801061f9:	6a 3c                	push   $0x3c
  jmp alltraps
801061fb:	e9 d6 f8 ff ff       	jmp    80105ad6 <alltraps>
...
80106202:	6a 3d                	push   $0x3d
  jmp alltraps
80106204:	e9 cd f8 ff ff       	jmp    80105ad6 <alltraps>
...
8010620b:	6a 3e                	push   $0x3e
  jmp alltraps
8010620d:	e9 c4 f8 ff ff       	jmp    80105ad6 <alltraps>
...
80106214:	6a 3f                	push   $0x3f
  jmp alltraps
80106216:	e9 bb f8 ff ff       	jmp    80105ad6 <alltraps>
...
8010621d:	6a 40                	push   $0x40
  jmp alltraps
8010621f:	e9 b2 f8 ff ff       	jmp    80105ad6 <alltraps>
...
80106226:	6a 41                	push   $0x41
  jmp alltraps
80106228:	e9 a9 f8 ff ff       	jmp    80105ad6 <alltraps>
...
8010622f:	6a 42                	push   $0x42
  jmp alltraps
80106231:	e9 a0 f8 ff ff       	jmp    80105ad6 <alltraps>
...
80106238:	6a 43                	push   $0x43
  jmp alltraps
8010623a:	e9 97 f8 ff ff       	jmp    80105ad6 <alltraps>
...
80106241:	6a 44                	push   $0x44
  jmp alltraps
80106243:	e9 8e f8 ff ff       	jmp    80105ad6 <alltraps>
...
8010624a:	6a 45                	push   $0x45
  jmp alltraps
8010624c:	e9 85 f8 ff ff       	jmp    80105ad6 <alltraps>
...
80106253:	6a 46                	push   $0x46
  jmp alltraps
80106255:	e9 7c f8 ff ff       	jmp    80105ad6 <alltraps>
...
8010625c:	6a 47                	push   $0x47
  jmp alltraps
8010625e:	e9 73 f8 ff ff       	jmp    80105ad6 <alltraps>
...
80106265:	6a 48                	push   $0x48
  jmp alltraps
80106267:	e9 6a f8 ff ff       	jmp    80105ad6 <alltraps>
...
8010626e:	6a 49                	push   $0x49
  jmp alltraps
80106270:	e9 61 f8 ff ff       	jmp    80105ad6 <alltraps>
...
80106277:	6a 4a                	push   $0x4a
  jmp alltraps
80106279:	e9 58 f8 ff ff       	jmp    80105ad6 <alltraps>
...
80106280:	6a 4b                	push   $0x4b
  jmp alltraps
80106282:	e9 4f f8 ff ff       	jmp    80105ad6 <alltraps>
...
80106289:	6a 4c                	push   $0x4c
  jmp alltraps
8010628b:	e9 46 f8 ff ff       	jmp    80105ad6 <alltraps>
...
80106292:	6a 4d                	push   $0x4d
  jmp alltraps
80106294:	e9 3d f8 ff ff       	jmp    80105ad6 <alltraps>
...
8010629b:	6a 4e                	push   $0x4e
  jmp alltraps
8010629d:	e9 34 f8 ff ff       	jmp    80105ad6 <alltraps>
...
801062a4:	6a 4f                	push   $0x4f
  jmp alltraps
801062a6:	e9 2b f8 ff ff       	jmp    80105ad6 <alltraps>
...
801062ad:	6a 50                	push   $0x50
  jmp alltraps
801062af:	e9 22 f8 ff ff       	jmp    80105ad6 <alltraps>
...
801062b6:	6a 51                	push   $0x51
  jmp alltraps
801062b8:	e9 19 f8 ff ff       	jmp    80105ad6 <alltraps>
...
801062bf:	6a 52                	push   $0x52
  jmp alltraps
801062c1:	e9 10 f8 ff ff       	jmp    80105ad6 <alltraps>
...
801062c8:	6a 53                	push   $0x53
  jmp alltraps
801062ca:	e9 07 f8 ff ff       	jmp    80105ad6 <alltraps>
...
801062d1:	6a 54                	push   $0x54
  jmp alltraps
801062d3:	e9 fe f7 ff ff       	jmp    80105ad6 <alltraps>
...
801062da:	6a 55                	push   $0x55
  jmp alltraps
801062dc:	e9 f5 f7 ff ff       	jmp    80105ad6 <alltraps>
...
801062e3:	6a 56                	push   $0x56
  jmp alltraps
801062e5:	e9 ec f7 ff ff       	jmp    80105ad6 <alltraps>
...
801062ec:	6a 57                	push   $0x57
  jmp alltraps
801062ee:	e9 e3 f7 ff ff       	jmp    80105ad6 <alltraps>
...
801062f5:	6a 58                	push   $0x58
  jmp alltraps
801062f7:	e9 da f7 ff ff       	jmp    80105ad6 <alltraps>
...
801062fe:	6a 59                	push   $0x59
  jmp alltraps
80106300:	e9 d1 f7 ff ff       	jmp    80105ad6 <alltraps>
...
80106307:	6a 5a                	push   $0x5a
  jmp alltraps
80106309:	e9 c8 f7 ff ff       	jmp    80105ad6 <alltraps>
...
80106310:	6a 5b                	push   $0x5b
  jmp alltraps
80106312:	e9 bf f7 ff ff       	jmp    80105ad6 <alltraps>
...
80106319:	6a 5c                	push   $0x5c
  jmp alltraps
8010631b:	e9 b6 f7 ff ff       	jmp    80105ad6 <alltraps>
...
80106322:	6a 5d                	push   $0x5d
  jmp alltraps
80106324:	e9 ad f7 ff ff       	jmp    80105ad6 <alltraps>
...
8010632b:	6a 5e                	push   $0x5e
  jmp alltraps
8010632d:	e9 a4 f7 ff ff       	jmp    80105ad6 <alltraps>
...
80106334:	6a 5f                	push   $0x5f
  jmp alltraps
80106336:	e9 9b f7 ff ff       	jmp    80105ad6 <alltraps>
...
8010633d:	6a 60                	push   $0x60
  jmp alltraps
8010633f:	e9 92 f7 ff ff       	jmp    80105ad6 <alltraps>
...
80106346:	6a 61                	push   $0x61
  jmp alltraps
80106348:	e9 89 f7 ff ff       	jmp    80105ad6 <alltraps>
...
8010634f:	6a 62                	push   $0x62
  jmp alltraps
80106351:	e9 80 f7 ff ff       	jmp    80105ad6 <alltraps>
...
80106358:	6a 63                	push   $0x63
  jmp alltraps
8010635a:	e9 77 f7 ff ff       	jmp    80105ad6 <alltraps>
...
80106361:	6a 64                	push   $0x64
  jmp alltraps
80106363:	e9 6e f7 ff ff       	jmp    80105ad6 <alltraps>
...
8010636a:	6a 65                	push   $0x65
  jmp alltraps
8010636c:	e9 65 f7 ff ff       	jmp    80105ad6 <alltraps>
...
80106373:	6a 66                	push   $0x66
  jmp alltraps
80106375:	e9 5c f7 ff ff       	jmp    80105ad6 <alltraps>
...
8010637c:	6a 67                	push   $0x67
  jmp alltraps
8010637e:	e9 53 f7 ff ff       	jmp    80105ad6 <alltraps>
...
80106385:	6a 68                	push   $0x68
  jmp alltraps
80106387:	e9 4a f7 ff ff       	jmp    80105ad6 <alltraps>
...
8010638e:	6a 69                	push   $0x69
  jmp alltraps
80106390:	e9 41 f7 ff ff       	jmp    80105ad6 <alltraps>
...
80106397:	6a 6a                	push   $0x6a
  jmp alltraps
80106399:	e9 38 f7 ff ff       	jmp    80105ad6 <alltraps>
...
801063a0:	6a 6b                	push   $0x6b
  jmp alltraps
801063a2:	e9 2f f7 ff ff       	jmp    80105ad6 <alltraps>
...
801063a9:	6a 6c                	push   $0x6c
  jmp alltraps
801063ab:	e9 26 f7 ff ff       	jmp    80105ad6 <alltraps>
...
801063b2:	6a 6d                	push   $0x6d
  jmp alltraps
801063b4:	e9 1d f7 ff ff       	jmp    80105ad6 <alltraps>
...
801063bb:	6a 6e                	push   $0x6e
  jmp alltraps
801063bd:	e9 14 f7 ff ff       	jmp    80105ad6 <alltraps>
...
801063c4:	6a 6f                	push   $0x6f
  jmp alltraps
801063c6:	e9 0b f7 ff ff       	jmp    80105ad6 <alltraps>
...
801063cd:	6a 70                	push   $0x70
  jmp alltraps
801063cf:	e9 02 f7 ff ff       	jmp    80105ad6 <alltraps>
...
801063d6:	6a 71                	push   $0x71
  jmp alltraps
801063d8:	e9 f9 f6 ff ff       	jmp    80105ad6 <alltraps>
...
801063df:	6a 72                	push   $0x72
  jmp alltraps
801063e1:	e9 f0 f6 ff ff       	jmp    80105ad6 <alltraps>
...
801063e8:	6a 73                	push   $0x73
  jmp alltraps
801063ea:	e9 e7 f6 ff ff       	jmp    80105ad6 <alltraps>
...
801063f1:	6a 74                	push   $0x74
  jmp alltraps
801063f3:	e9 de f6 ff ff       	jmp    80105ad6 <alltraps>
...
801063fa:	6a 75                	push   $0x75
  jmp alltraps
801063fc:	e9 d5 f6 ff ff       	jmp    80105ad6 <alltraps>
...
80106403:	6a 76                	push   $0x76
  jmp alltraps
80106405:	e9 cc f6 ff ff       	jmp    80105ad6 <alltraps>
...
8010640c:	6a 77                	push   $0x77
  jmp alltraps
8010640e:	e9 c3 f6 ff ff       	jmp    80105ad6 <alltraps>
...
80106415:	6a 78                	push   $0x78
  jmp alltraps
80106417:	e9 ba f6 ff ff       	jmp    80105ad6 <alltraps>
...
8010641e:	6a 79                	push   $0x79
  jmp alltraps
80106420:	e9 b1 f6 ff ff       	jmp    80105ad6 <alltraps>
...
80106427:	6a 7a                	push   $0x7a
  jmp alltraps
80106429:	e9 a8 f6 ff ff       	jmp    80105ad6 <alltraps>
...
80106430:	6a 7b                	push   $0x7b
  jmp alltraps
80106432:	e9 9f f6 ff ff       	jmp    80105ad6 <alltraps>
...
80106439:	6a 7c                	push   $0x7c
  jmp alltraps
8010643b:	e9 96 f6 ff ff       	jmp    80105ad6 <alltraps>
...
80106442:	6a 7d                	push   $0x7d
  jmp alltraps
80106444:	e9 8d f6 ff ff       	jmp    80105ad6 <alltraps>
...
8010644b:	6a 7e                	push   $0x7e
  jmp alltraps
8010644d:	e9 84 f6 ff ff       	jmp    80105ad6 <alltraps>
...
80106454:	6a 7f                	push   $0x7f
  jmp alltraps
80106456:	e9 7b f6 ff ff       	jmp    80105ad6 <alltraps>
...
8010645d:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80106462:	e9 6f f6 ff ff       	jmp    80105ad6 <alltraps>
...
80106469:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010646e:	e9 63 f6 ff ff       	jmp    80105ad6 <alltraps>
...
80106475:	68 82 00 00 00       	push   $0x82
  jmp alltraps
8010647a:	e9 57 f6 ff ff       	jmp    80105ad6 <alltraps>
...
80106481:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106486:	e9 4b f6 ff ff       	jmp    80105ad6 <alltraps>
...
8010648d:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80106492:	e9 3f f6 ff ff       	jmp    80105ad6 <alltraps>
...
80106499:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010649e:	e9 33 f6 ff ff       	jmp    80105ad6 <alltraps>
...
801064a5:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801064aa:	e9 27 f6 ff ff       	jmp    80105ad6 <alltraps>
...
801064b1:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801064b6:	e9 1b f6 ff ff       	jmp    80105ad6 <alltraps>
...
801064bd:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801064c2:	e9 0f f6 ff ff       	jmp    80105ad6 <alltraps>
...
801064c9:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801064ce:	e9 03 f6 ff ff       	jmp    80105ad6 <alltraps>
...
801064d5:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801064da:	e9 f7 f5 ff ff       	jmp    80105ad6 <alltraps>
...
801064e1:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801064e6:	e9 eb f5 ff ff       	jmp    80105ad6 <alltraps>
...
801064ed:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801064f2:	e9 df f5 ff ff       	jmp    80105ad6 <alltraps>
...
801064f9:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801064fe:	e9 d3 f5 ff ff       	jmp    80105ad6 <alltraps>
...
80106505:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
8010650a:	e9 c7 f5 ff ff       	jmp    80105ad6 <alltraps>
...
80106511:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106516:	e9 bb f5 ff ff       	jmp    80105ad6 <alltraps>
...
8010651d:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80106522:	e9 af f5 ff ff       	jmp    80105ad6 <alltraps>
...
80106529:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010652e:	e9 a3 f5 ff ff       	jmp    80105ad6 <alltraps>
...
80106535:	68 92 00 00 00       	push   $0x92
  jmp alltraps
8010653a:	e9 97 f5 ff ff       	jmp    80105ad6 <alltraps>
...
80106541:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106546:	e9 8b f5 ff ff       	jmp    80105ad6 <alltraps>
...
8010654d:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80106552:	e9 7f f5 ff ff       	jmp    80105ad6 <alltraps>
...
80106559:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010655e:	e9 73 f5 ff ff       	jmp    80105ad6 <alltraps>
...
80106565:	68 96 00 00 00       	push   $0x96
  jmp alltraps
8010656a:	e9 67 f5 ff ff       	jmp    80105ad6 <alltraps>
...
80106571:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106576:	e9 5b f5 ff ff       	jmp    80105ad6 <alltraps>
...
8010657d:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80106582:	e9 4f f5 ff ff       	jmp    80105ad6 <alltraps>
...
80106589:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010658e:	e9 43 f5 ff ff       	jmp    80105ad6 <alltraps>
...
80106595:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
8010659a:	e9 37 f5 ff ff       	jmp    80105ad6 <alltraps>
...
801065a1:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801065a6:	e9 2b f5 ff ff       	jmp    80105ad6 <alltraps>
...
801065ad:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801065b2:	e9 1f f5 ff ff       	jmp    80105ad6 <alltraps>
...
801065b9:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801065be:	e9 13 f5 ff ff       	jmp    80105ad6 <alltraps>
...
801065c5:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801065ca:	e9 07 f5 ff ff       	jmp    80105ad6 <alltraps>
...
801065d1:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801065d6:	e9 fb f4 ff ff       	jmp    80105ad6 <alltraps>
...
801065dd:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801065e2:	e9 ef f4 ff ff       	jmp    80105ad6 <alltraps>
...
801065e9:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801065ee:	e9 e3 f4 ff ff       	jmp    80105ad6 <alltraps>
...
801065f5:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801065fa:	e9 d7 f4 ff ff       	jmp    80105ad6 <alltraps>
...
80106601:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106606:	e9 cb f4 ff ff       	jmp    80105ad6 <alltraps>
...
8010660d:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80106612:	e9 bf f4 ff ff       	jmp    80105ad6 <alltraps>
...
80106619:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010661e:	e9 b3 f4 ff ff       	jmp    80105ad6 <alltraps>
...
80106625:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
8010662a:	e9 a7 f4 ff ff       	jmp    80105ad6 <alltraps>
...
80106631:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106636:	e9 9b f4 ff ff       	jmp    80105ad6 <alltraps>
...
8010663d:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80106642:	e9 8f f4 ff ff       	jmp    80105ad6 <alltraps>
...
80106649:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010664e:	e9 83 f4 ff ff       	jmp    80105ad6 <alltraps>
...
80106655:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
8010665a:	e9 77 f4 ff ff       	jmp    80105ad6 <alltraps>
...
80106661:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106666:	e9 6b f4 ff ff       	jmp    80105ad6 <alltraps>
...
8010666d:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80106672:	e9 5f f4 ff ff       	jmp    80105ad6 <alltraps>
...
80106679:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010667e:	e9 53 f4 ff ff       	jmp    80105ad6 <alltraps>
...
80106685:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
8010668a:	e9 47 f4 ff ff       	jmp    80105ad6 <alltraps>
...
80106691:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106696:	e9 3b f4 ff ff       	jmp    80105ad6 <alltraps>
...
8010669d:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801066a2:	e9 2f f4 ff ff       	jmp    80105ad6 <alltraps>
...
801066a9:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801066ae:	e9 23 f4 ff ff       	jmp    80105ad6 <alltraps>
...
801066b5:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801066ba:	e9 17 f4 ff ff       	jmp    80105ad6 <alltraps>
...
801066c1:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801066c6:	e9 0b f4 ff ff       	jmp    80105ad6 <alltraps>
...
801066cd:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801066d2:	e9 ff f3 ff ff       	jmp    80105ad6 <alltraps>
...
801066d9:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801066de:	e9 f3 f3 ff ff       	jmp    80105ad6 <alltraps>
...
801066e5:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801066ea:	e9 e7 f3 ff ff       	jmp    80105ad6 <alltraps>
...
801066f1:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801066f6:	e9 db f3 ff ff       	jmp    80105ad6 <alltraps>
...
801066fd:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80106702:	e9 cf f3 ff ff       	jmp    80105ad6 <alltraps>
...
80106709:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010670e:	e9 c3 f3 ff ff       	jmp    80105ad6 <alltraps>
...
80106715:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
8010671a:	e9 b7 f3 ff ff       	jmp    80105ad6 <alltraps>
...
80106721:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106726:	e9 ab f3 ff ff       	jmp    80105ad6 <alltraps>
...
8010672d:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80106732:	e9 9f f3 ff ff       	jmp    80105ad6 <alltraps>
...
80106739:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010673e:	e9 93 f3 ff ff       	jmp    80105ad6 <alltraps>
...
80106745:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
8010674a:	e9 87 f3 ff ff       	jmp    80105ad6 <alltraps>
...
80106751:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106756:	e9 7b f3 ff ff       	jmp    80105ad6 <alltraps>
...
8010675d:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80106762:	e9 6f f3 ff ff       	jmp    80105ad6 <alltraps>
...
80106769:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010676e:	e9 63 f3 ff ff       	jmp    80105ad6 <alltraps>
...
80106775:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
8010677a:	e9 57 f3 ff ff       	jmp    80105ad6 <alltraps>
...
80106781:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106786:	e9 4b f3 ff ff       	jmp    80105ad6 <alltraps>
...
8010678d:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80106792:	e9 3f f3 ff ff       	jmp    80105ad6 <alltraps>
...
80106799:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010679e:	e9 33 f3 ff ff       	jmp    80105ad6 <alltraps>
...
801067a5:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801067aa:	e9 27 f3 ff ff       	jmp    80105ad6 <alltraps>
...
801067b1:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801067b6:	e9 1b f3 ff ff       	jmp    80105ad6 <alltraps>
...
801067bd:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801067c2:	e9 0f f3 ff ff       	jmp    80105ad6 <alltraps>
...
801067c9:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801067ce:	e9 03 f3 ff ff       	jmp    80105ad6 <alltraps>
...
801067d5:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801067da:	e9 f7 f2 ff ff       	jmp    80105ad6 <alltraps>
...
801067e1:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801067e6:	e9 eb f2 ff ff       	jmp    80105ad6 <alltraps>
...
801067ed:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801067f2:	e9 df f2 ff ff       	jmp    80105ad6 <alltraps>
...
801067f9:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801067fe:	e9 d3 f2 ff ff       	jmp    80105ad6 <alltraps>
...
80106805:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
8010680a:	e9 c7 f2 ff ff       	jmp    80105ad6 <alltraps>
...
80106811:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106816:	e9 bb f2 ff ff       	jmp    80105ad6 <alltraps>
...
8010681d:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80106822:	e9 af f2 ff ff       	jmp    80105ad6 <alltraps>
...
80106829:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010682e:	e9 a3 f2 ff ff       	jmp    80105ad6 <alltraps>
...
80106835:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
8010683a:	e9 97 f2 ff ff       	jmp    80105ad6 <alltraps>
...
80106841:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106846:	e9 8b f2 ff ff       	jmp    80105ad6 <alltraps>
...
8010684d:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80106852:	e9 7f f2 ff ff       	jmp    80105ad6 <alltraps>
...
80106859:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010685e:	e9 73 f2 ff ff       	jmp    80105ad6 <alltraps>
...
80106865:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
8010686a:	e9 67 f2 ff ff       	jmp    80105ad6 <alltraps>
...
80106871:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106876:	e9 5b f2 ff ff       	jmp    80105ad6 <alltraps>
...
8010687d:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80106882:	e9 4f f2 ff ff       	jmp    80105ad6 <alltraps>
...
80106889:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010688e:	e9 43 f2 ff ff       	jmp    80105ad6 <alltraps>
...
80106895:	68 da 00 00 00       	push   $0xda
  jmp alltraps
8010689a:	e9 37 f2 ff ff       	jmp    80105ad6 <alltraps>
...
801068a1:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801068a6:	e9 2b f2 ff ff       	jmp    80105ad6 <alltraps>
...
801068ad:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801068b2:	e9 1f f2 ff ff       	jmp    80105ad6 <alltraps>
...
801068b9:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801068be:	e9 13 f2 ff ff       	jmp    80105ad6 <alltraps>
...
801068c5:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801068ca:	e9 07 f2 ff ff       	jmp    80105ad6 <alltraps>
...
801068d1:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801068d6:	e9 fb f1 ff ff       	jmp    80105ad6 <alltraps>
...
801068dd:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801068e2:	e9 ef f1 ff ff       	jmp    80105ad6 <alltraps>
...
801068e9:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801068ee:	e9 e3 f1 ff ff       	jmp    80105ad6 <alltraps>
...
801068f5:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801068fa:	e9 d7 f1 ff ff       	jmp    80105ad6 <alltraps>
...
80106901:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106906:	e9 cb f1 ff ff       	jmp    80105ad6 <alltraps>
...
8010690d:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80106912:	e9 bf f1 ff ff       	jmp    80105ad6 <alltraps>
...
80106919:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010691e:	e9 b3 f1 ff ff       	jmp    80105ad6 <alltraps>
...
80106925:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
8010692a:	e9 a7 f1 ff ff       	jmp    80105ad6 <alltraps>
...
80106931:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106936:	e9 9b f1 ff ff       	jmp    80105ad6 <alltraps>
...
8010693d:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80106942:	e9 8f f1 ff ff       	jmp    80105ad6 <alltraps>
...
80106949:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010694e:	e9 83 f1 ff ff       	jmp    80105ad6 <alltraps>
...
80106955:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
8010695a:	e9 77 f1 ff ff       	jmp    80105ad6 <alltraps>
...
80106961:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106966:	e9 6b f1 ff ff       	jmp    80105ad6 <alltraps>
...
8010696d:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80106972:	e9 5f f1 ff ff       	jmp    80105ad6 <alltraps>
...
80106979:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010697e:	e9 53 f1 ff ff       	jmp    80105ad6 <alltraps>
...
80106985:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
8010698a:	e9 47 f1 ff ff       	jmp    80105ad6 <alltraps>
...
80106991:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106996:	e9 3b f1 ff ff       	jmp    80105ad6 <alltraps>
...
8010699d:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801069a2:	e9 2f f1 ff ff       	jmp    80105ad6 <alltraps>
...
801069a9:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801069ae:	e9 23 f1 ff ff       	jmp    80105ad6 <alltraps>
...
801069b5:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801069ba:	e9 17 f1 ff ff       	jmp    80105ad6 <alltraps>
...
801069c1:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801069c6:	e9 0b f1 ff ff       	jmp    80105ad6 <alltraps>
...
801069cd:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801069d2:	e9 ff f0 ff ff       	jmp    80105ad6 <alltraps>
...
801069d9:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801069de:	e9 f3 f0 ff ff       	jmp    80105ad6 <alltraps>
...
801069e5:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801069ea:	e9 e7 f0 ff ff       	jmp    80105ad6 <alltraps>
...
801069f1:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801069f6:	e9 db f0 ff ff       	jmp    80105ad6 <alltraps>
...
801069fd:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80106a02:	e9 cf f0 ff ff       	jmp    80105ad6 <alltraps>
...
80106a09:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106a0e:	e9 c3 f0 ff ff       	jmp    80105ad6 <alltraps>
...
80106a15:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106a1a:	e9 b7 f0 ff ff       	jmp    80105ad6 <alltraps>
...
80106a21:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106a26:	e9 ab f0 ff ff       	jmp    80105ad6 <alltraps>
...
80106a2d:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80106a32:	e9 9f f0 ff ff       	jmp    80105ad6 <alltraps>
...
80106a39:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106a3e:	e9 93 f0 ff ff       	jmp    80105ad6 <alltraps>
...
80106a45:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106a4a:	e9 87 f0 ff ff       	jmp    80105ad6 <alltraps>
...
80106a51:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106a56:	e9 7b f0 ff ff       	jmp    80105ad6 <alltraps>
...
80106aba:	e8 31 dd ff ff       	call   801047f0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106b5d:	68 a8 7d 10 80       	push   $0x80107da8
...
80106c13:	68 a6 76 10 80       	push   $0x801076a6
...
80106c3e:	c7 80 f8 27 11 80 ff 	movl   $0xffff,-0x7feed808(%eax)
80106c45:	ff 00 00 
80106c48:	c7 80 fc 27 11 80 00 	movl   $0xcf9a00,-0x7feed804(%eax)
80106c4f:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106c52:	c7 80 00 28 11 80 ff 	movl   $0xffff,-0x7feed800(%eax)
80106c59:	ff 00 00 
80106c5c:	c7 80 04 28 11 80 00 	movl   $0xcf9200,-0x7feed7fc(%eax)
80106c63:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106c66:	c7 80 08 28 11 80 ff 	movl   $0xffff,-0x7feed7f8(%eax)
80106c6d:	ff 00 00 
80106c70:	c7 80 0c 28 11 80 00 	movl   $0xcffa00,-0x7feed7f4(%eax)
80106c77:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106c7a:	c7 80 10 28 11 80 ff 	movl   $0xffff,-0x7feed7f0(%eax)
80106c81:	ff 00 00 
80106c84:	c7 80 14 28 11 80 00 	movl   $0xcff200,-0x7feed7ec(%eax)
80106c8b:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
80106c8e:	05 f0 27 11 80       	add    $0x801127f0,%eax
  pd[1] = (uint)p;
...
80106cb4:	a1 a4 54 11 80       	mov    0x801154a4,%eax
...
80106cf8:	0f 84 c2 00 00 00    	je     80106dc0 <switchuvm+0xf0>
  pushcli();
80106cfe:	e8 dd d8 ff ff       	call   801045e0 <pushcli>
...
80106e13:	e8 d8 d9 ff ff       	call   801047f0 <memset>
...
80106e46:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106e47:	e9 44 da ff ff       	jmp    80104890 <memmove>
    panic("inituvm: more than a page");
80106e4c:	83 ec 0c             	sub    $0xc,%esp
80106e4f:	68 ed 7d 10 80       	push   $0x80107ded
...
80106f7b:	e8 70 d8 ff ff       	call   801047f0 <memset>
...
80106fb9:	68 25 7e 10 80       	push   $0x80107e25
...
8010701b:	68 3d 7e 10 80       	push   $0x80107e3d
...
801070fc:	68 59 7e 10 80       	push   $0x80107e59
...
80107134:	e8 b7 d6 ff ff       	call   801047f0 <memset>
...
8010719f:	a3 a4 54 11 80       	mov    %eax,0x801154a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
801071d3:	68 6a 7e 10 80       	push   $0x80107e6a
...
80107220:	e8 6b d6 ff ff       	call   80104890 <memmove>
...
801072b9:	68 8e 7e 10 80       	push   $0x80107e8e
801072be:	e8 cd 90 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
801072c3:	83 ec 0c             	sub    $0xc,%esp
801072c6:	68 74 7e 10 80       	push   $0x80107e74
...
8010734e:	e8 3d d5 ff ff       	call   80104890 <memmove>
    len -= n;
    buf += n;
...
801073a0 <page_fault_handler>:
//PAGEBREAK!
// Blank page.

// Copied from allocuvm()
int page_fault_handler(pde_t *pgdir, uint a)
{
...
801073a8:	83 ec 04             	sub    $0x4,%esp
  char *mem = kalloc();
801073ab:	e8 80 b2 ff ff       	call   80102630 <kalloc>
  if(mem == 0){
801073b0:	85 c0                	test   %eax,%eax
801073b2:	74 44                	je     801073f8 <page_fault_handler+0x58>
...
801073dc:	e8 ff f6 ff ff       	call   80106ae0 <mappages>
...
801073e4:	89 c2                	mov    %eax,%edx
  ...
  return 1;
801073e6:	b8 01 00 00 00       	mov    $0x1,%eax
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
801073eb:	85 d2                	test   %edx,%edx
801073ed:	78 21                	js     80107410 <page_fault_handler+0x70>
801073ef:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801073f2:	c9                   	leave  
801073f3:	c3                   	ret    
801073f4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    cprintf("out of memory\n");
801073f8:	83 ec 0c             	sub    $0xc,%esp
801073fb:	68 2e 7e 10 80       	push   $0x80107e2e
80107400:	e8 ab 92 ff ff       	call   801006b0 <cprintf>
80107405:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    return 0;
...
80107413:	68 46 7e 10 80       	push   $0x80107e46
80107418:	e8 93 92 ff ff       	call   801006b0 <cprintf>
      kfree(mem);
8010741d:	89 1c 24             	mov    %ebx,(%esp)
80107420:	e8 4b b0 ff ff       	call   80102470 <kfree>
80107425:	8b 5d fc             	mov    -0x4(%ebp),%ebx
      return 0;
