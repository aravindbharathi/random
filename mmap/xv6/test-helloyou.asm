...
_test-helloyou:     file format elf32-i386
...
int main(void)
{
  ...
  23:	68 98 07 00 00       	push   $0x798
  28:	e8 2e 03 00 00       	call   35b <helloYou>
        helloYou("Welcome to XV6");
  2d:	c7 04 24 a9 07 00 00 	movl   $0x7a9,(%esp)
  34:	e8 22 03 00 00       	call   35b <helloYou>
    for (int i = 0; i < 10; i++){
