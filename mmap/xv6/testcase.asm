...
int main(void)
{
  ...
  15:	e8 19 04 00 00       	call   433 <numvp>
  ...
  2a:	e8 0c 04 00 00       	call   43b <numpp>
  2f:	83 c4 0c             	add    $0xc,%esp
  32:	50                   	push   %eax
  33:	68 7d 08 00 00       	push   $0x87d
  38:	6a 01                	push   $0x1
  3a:	e8 c1 04 00 00       	call   500 <printf>

  printf(1, "Hello, world!\n");
  3f:	58                   	pop    %eax
  40:	5a                   	pop    %edx
  41:	68 93 08 00 00       	push   $0x893
  46:	6a 01                	push   $0x1
  48:	e8 b3 04 00 00       	call   500 <printf>
  
  printf(1, "# Processes: %d\n", getNumProc());
  4d:	e8 d1 03 00 00       	call   423 <getNumProc>
  52:	83 c4 0c             	add    $0xc,%esp
  55:	50                   	push   %eax
  56:	68 a2 08 00 00       	push   $0x8a2
  5b:	6a 01                	push   $0x1
  5d:	e8 9e 04 00 00       	call   500 <printf>
  printf(1, "Calling sbrk: %d\n", sbrk(1*PGSIZE));
  62:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
  69:	e8 8d 03 00 00       	call   3fb <sbrk>
  6e:	83 c4 0c             	add    $0xc,%esp
  71:	50                   	push   %eax
  72:	68 b3 08 00 00       	push   $0x8b3
  77:	6a 01                	push   $0x1
  79:	e8 82 04 00 00       	call   500 <printf>
  printf(1, "Calling sbrk: %d\n", sbrk(1));
  7e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  85:	e8 71 03 00 00       	call   3fb <sbrk>
  8a:	83 c4 0c             	add    $0xc,%esp
  8d:	50                   	push   %eax
  8e:	68 b3 08 00 00       	push   $0x8b3
  93:	6a 01                	push   $0x1
  95:	e8 66 04 00 00       	call   500 <printf>
  printf(1, "Calling mmap: %d\n", mmap(1*PGSIZE));
  9a:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
  a1:	e8 9d 03 00 00       	call   443 <mmap>
  a6:	83 c4 0c             	add    $0xc,%esp
  a9:	50                   	push   %eax
  aa:	68 c5 08 00 00       	push   $0x8c5
  af:	6a 01                	push   $0x1
  b1:	e8 4a 04 00 00       	call   500 <printf>
  printf(1, "Calling mmap: %d\n", mmap(-1*PGSIZE));
  b6:	c7 04 24 00 f0 ff ff 	movl   $0xfffff000,(%esp)
  bd:	e8 81 03 00 00       	call   443 <mmap>
  c2:	83 c4 0c             	add    $0xc,%esp
  c5:	50                   	push   %eax
  c6:	68 c5 08 00 00       	push   $0x8c5
  cb:	6a 01                	push   $0x1
  cd:	e8 2e 04 00 00       	call   500 <printf>
  printf(1, "# Virtual Pages: %d\n", numvp());
  d2:	e8 5c 03 00 00       	call   433 <numvp>
  d7:	83 c4 0c             	add    $0xc,%esp
  da:	50                   	push   %eax
  db:	68 68 08 00 00       	push   $0x868
  e0:	6a 01                	push   $0x1
  e2:	e8 19 04 00 00       	call   500 <printf>
  printf(1, "# Physical Pages: %d\n", numpp());
  e7:	e8 4f 03 00 00       	call   43b <numpp>
  ec:	83 c4 0c             	add    $0xc,%esp
  ef:	50                   	push   %eax
  f0:	68 7d 08 00 00       	push   $0x87d
  f5:	6a 01                	push   $0x1
  f7:	e8 04 04 00 00       	call   500 <printf>
  exit();
  fc:	e8 72 02 00 00       	call   373 <exit>
 ...
 45c:	89 d1                	mov    %edx,%ecx
{
 ...
 489:	0f b6 92 e0 08 00 00 	movzbl 0x8e0(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 684:	eb 1a                	jmp    6a0 <printf+0x1a0>
          s = "(null)";
 686:	bb d7 08 00 00       	mov    $0x8d7,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6d5:	a1 88 0b 00 00       	mov    0xb88,%eax
{
 ...
 6f6:	73 10                	jae    708 <free+0x38>
{
 ...
 721:	5b                   	pop    %ebx
  freep = p;
 722:	a3 88 0b 00 00       	mov    %eax,0xb88
}
 727:	5e                   	pop    %esi
 728:	5f                   	pop    %edi
 729:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 76d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 770:	8b 3d 88 0b 00 00    	mov    0xb88,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7b9:	8b 3d 88 0b 00 00    	mov    0xb88,%edi
 ...
 814:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 817:	a3 88 0b 00 00       	mov    %eax,0xb88
}
 ...
 82e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 830:	c7 05 88 0b 00 00 8c 	movl   $0xb8c,0xb88
 837:	0b 00 00 
    base.s.size = 0;
 83a:	bf 8c 0b 00 00       	mov    $0xb8c,%edi
    base.s.ptr = freep = prevp = &base;
 83f:	c7 05 8c 0b 00 00 8c 	movl   $0xb8c,0xb8c
 846:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 849:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 84b:	c7 05 90 0b 00 00 00 	movl   $0x0,0xb90
 852:	00 00 00 
    if(p->s.size >= nunits){
