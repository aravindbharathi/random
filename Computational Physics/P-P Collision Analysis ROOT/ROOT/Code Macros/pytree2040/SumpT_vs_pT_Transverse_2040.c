...
void SumpT_vs_pT_Transverse_2040(){
    ...
    TCanvas* c1 = new TCanvas("c1","SumpT_vs_pT_Transverse_2040", 480, 360);
    ...
    TH2D* h = new TH2D("h","Average #sump_{T} vs p_{T}^{lead} for multiplicity class 20 to 40 in Transverse Region",50,0,5,50,0,50);
