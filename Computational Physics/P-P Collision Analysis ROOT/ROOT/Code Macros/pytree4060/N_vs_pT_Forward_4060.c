...
void N_vs_pT_Forward_4060(){
    ...
    // Define the canvas
    TCanvas* c1 = new TCanvas("c1","N_vs_pT_Forward_4060", 480, 360);
    ...
    TH2D* h = new TH2D("h","Average Number Density vs p_{T}^{lead} for multiplicity class 40 to 60 in Toward Region",50,0,5,50,0,4);
