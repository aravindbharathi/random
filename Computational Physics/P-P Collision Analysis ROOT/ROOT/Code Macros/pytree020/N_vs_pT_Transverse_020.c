...
void N_vs_pT_Transverse_020(){
    ...
    // Define the canvas
    TCanvas* c1 = new TCanvas("c1","N_vs_pT_Transverse_020", 480, 360);
    ...
    TH2D* h = new TH2D("h","Average Number Density vs p_{T}^{lead} for multiplicity class 0 to 20 in Transverse Region",50,0,5,50,0,50);
