...
void SumpT_vs_pT_Forward_020(){
    ...
    TCanvas* c1 = new TCanvas("c1","SumpT_vs_pT_Forward_020", 480, 360);
    ...
    TH2D* h = new TH2D("h","Average #sump_{T} vs p_{T}^{lead} for multiplicity class 0 to 20 in Toward Region",50,0,5,50,0,50);
